	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand)
	{
		...
		else
		{
			...
			else
			{
				...
				BlockPos otherPos = isReplaceable && rayTrace.sideHit == EnumFacing.UP ? pos : pos.offset(rayTrace.sideHit);

				if (!player.canPlayerEdit(otherPos, rayTrace.sideHit, stack))
					return new ActionResult<ItemStack>(EnumActionResult.FAIL, stack);
				else if (this.tryPlaceContainedLiquid(player, world, otherPos))
				{
					player.addStat(StatList.getObjectUseStats(this));
