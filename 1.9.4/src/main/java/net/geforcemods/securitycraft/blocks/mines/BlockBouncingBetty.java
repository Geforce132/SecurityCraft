...
public class BlockBouncingBetty extends BlockExplosive implements IIntersectable {
	...
	public void explode(World world, BlockPos pos){
		...
		WorldUtils.addScheduledTask(world, () -> world.spawnEntityInWorld(bouncingBetty));
		bouncingBetty.playSound(SoundEvent.REGISTRY.getObject(new ResourceLocation("game.tnt.primed")), 1.0F, 1.0F);
	}
