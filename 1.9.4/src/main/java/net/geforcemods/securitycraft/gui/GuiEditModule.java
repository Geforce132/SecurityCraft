...
public class GuiEditModule extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
		fontRendererObj.drawSplitString(ClientUtils.localize("gui.securitycraft:editModule"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("gui.securitycraft:editModule")) / 2, 6, xSize, 4210752);
	}
