...
public class GuiIMS extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
		fontRendererObj.drawString(ClientUtils.localize("tile.securitycraft:ims.name"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("tile.securitycraft:ims.name")) / 2, 6, 4210752);
		fontRendererObj.drawString(ClientUtils.localize("gui.securitycraft:ims.target"), xSize / 2 - 78, 30, 4210752);
	}
