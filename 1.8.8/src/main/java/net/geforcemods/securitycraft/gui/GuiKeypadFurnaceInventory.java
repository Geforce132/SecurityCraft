...
public class GuiKeypadFurnaceInventory extends GuiContainer{
    ...
    {
        String s = gurnace ? "Keypad Gurnace" : (this.tileFurnace.hasCustomName() ? this.tileFurnace.getCommandSenderName() : I18n.format(StatCollector.translateToLocal("gui.protectedFurnace.name"), new Object[0]));
