...
public class ConfigHandler
{
	...
	@Name("Monitors shut off after 5 minutes?")
	@LangKey("config.securitycraft:fiveMinAutoShutoff")
	public static boolean fiveMinAutoShutoff = true;

	@Name("Use LookingGlass for viewing cameras?")
	@LangKey("config.securitycraft:useLookingGlass")
	public static boolean useLookingGlass = true;
}
