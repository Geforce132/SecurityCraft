	...
	public void drawScreen(int par1, int par2, float par3){		
	    ...
	    if(this.currentPage > -1){
	    	if(mod_SecurityCraft.instance.manualPages.get(currentPage).getHelpInfo().equals("help.reinforced.info"))
	    		this.fontRenderer.drawString(ClientUtils.localize("gui.scManual.reinforced"), k + 39, 27, 0, false);
	    	else
	    	...
	    	this.fontRenderer.drawSplitString(ClientUtils.localize(mod_SecurityCraft.instance.manualPages.get(currentPage).getHelpInfo()), k + 18, 45, 225, 0);
	    }else{
