...
public class GuiMRATDeactivate extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		fontRenderer.drawString(TextFormatting.UNDERLINE + ClientUtils.localize("gui.mrat.deactivate"), xSize / 2 - fontRenderer.getStringWidth(ClientUtils.localize("gui.mrat.detonate")) / 2, 6, 4210752);
	}
