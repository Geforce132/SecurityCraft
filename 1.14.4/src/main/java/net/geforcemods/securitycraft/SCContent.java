...
public class SCContent
{
	...
	@Ownable @RegisterItemBlock(1) public static Block bouncingBetty;
	@RegisterItemBlock public static Block cageTrap;
	@RegisterItemBlock(1) public static Block claymore;
	@Ownable @RegisterItemBlock(1) public static Block cobblestoneMine;
	@Ownable @RegisterItemBlock(1) public static Block diamondOreMine;
	@Ownable @RegisterItemBlock(1) public static Block dirtMine;
	@Ownable @RegisterItemBlock public static Block frame;
	@Ownable @RegisterItemBlock(1) public static Block furnaceMine;
	@Ownable @RegisterItemBlock(1) public static Block gravelMine;
	...
	@Ownable @RegisterItemBlock(2) public static Block ironFence;
	@Ownable @RegisterItemBlock(2) public static Block ironTrapdoor;
	...
	@Ownable @RegisterItemBlock(2) public static Block reinforcedFencegate;
	@RegisterItemBlock public static Block retinalScanner;
	@Ownable @RegisterItemBlock(1) public static Block sandMine;
	...
	@Ownable @RegisterItemBlock(1) public static Block stoneMine;
	@Ownable @RegisterItemBlock(1) public static Block trackMine;
	@RegisterItemBlock public static Block usernameLogger;
	@Ownable @RegisterItemBlock(1) public static BlockMine mine;
