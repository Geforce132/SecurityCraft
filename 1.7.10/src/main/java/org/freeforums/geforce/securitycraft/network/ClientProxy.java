...
public class ClientProxy extends ServerProxy{
	...
	public void registerRenderThings(){
		...
		MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(mod_SecurityCraft.frame), new CustomModeledBlockRenderer(new TileEntityFrame(), new ModelKeypadFrame(), 0.0D, -0.1D, 0.0D, 0.0F));
