...
public class GuiKeypadFurnaceSetup extends GuiContainer
{
	...
	protected void actionPerformed(GuiButton guibutton){
		...
		case 0:
			...
			Minecraft.getMinecraft().thePlayer.openGui(mod_SecurityCraft.instance, 15, Minecraft.getMinecraft().theWorld, keypadInventory.xCoord, keypadInventory.yCoord, keypadInventory.zCoord);
