	...
	protected void actionPerformed(GuiButton guibutton){
		switch(guibutton.id){
			case 0:
				...
				try{
					outputStream.writeInt(this.TESC.xCoord);
					outputStream.writeInt(this.TESC.yCoord);
					outputStream.writeInt(this.TESC.zCoord);
					//Packet.writeString(this.textFields[0].getText(), outputStream);
					//Packet.writeString(this.textFields[1].getText(), outputStream);
					//Packet.writeString(this.textFields[2].getText(), outputStream);
					//Packet.writeString(this.textFields[3].getText(), outputStream);
					//Packet.writeString(this.textFields[4].getText(), outputStream);
					//Packet.writeString(this.textFields[5].getText(), outputStream);
					//Packet.writeString(this.textFields[6].getText(), outputStream);
					//Packet.writeString(this.textFields[7].getText(), outputStream);
					//Packet.writeString(this.textFields[8].getText(), outputStream);
					//Packet.writeString(this.textFields[9].getText(), outputStream);
