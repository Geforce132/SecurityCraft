...
import net.breakinbad.securitycraft.commands.CommandModule;
import net.breakinbad.securitycraft.commands.CommandSCHelp;
import net.breakinbad.securitycraft.gui.GuiHandler;
import net.breakinbad.securitycraft.handlers.ForgeEventHandler;
import net.breakinbad.securitycraft.imc.lookingglass.IWorldViewHelper;
import net.breakinbad.securitycraft.imc.lookingglass.LookingGlassPanelRenderer;
import net.breakinbad.securitycraft.imc.versionchecker.VersionUpdateChecker;
import net.breakinbad.securitycraft.ircbot.SCIRCBot;
...
import net.breakinbad.securitycraft.network.ConfigurationHandler;
import net.breakinbad.securitycraft.network.ServerProxy;
...
@Mod(modid = mod_SecurityCraft.MODID, name = "SecurityCraft", version = mod_SecurityCraft.VERSION, guiFactory = "net.breakinbad.securitycraft.gui.SecurityCraftGuiFactory", dependencies = mod_SecurityCraft.DEPENDENCIES)
...
public class mod_SecurityCraft {
	...
	public void init(FMLInitializationEvent event){
		...
		FMLInterModComms.sendMessage("LookingGlass", "API", "net.breakinbad.securitycraft.imc.lookingglass.LookingGlassAPIProvider.register");
