...
public class GuiEditModule extends GuiContainer
{
	...
	public void initGui()
	{
		...
		inputField = new GuiTextField(fontRendererObj, width / 2 - 50, height / 2 - 65, 100, 15);
	...
	protected void actionPerformed(GuiButton button){
		switch(button.id){
			case 0: //add
				...
				if(module.stackTagCompound == null)
					module.stackTagCompound = new NBTTagCompound();
				...
				module.stackTagCompound.setString("Player" + getNextSlot(module.stackTagCompound), inputField.getText());
				break;
			case 1: //remove
				if(inputField.getText().isEmpty())
					return;
				...
				break;
			case 2: //copy
				SecurityCraft.instance.setSavedModule(module.stackTagCompound);
				return;
			case 3: //paste
				module.stackTagCompound = SecurityCraft.instance.getSavedModule();
