...
public class GuiMRATActivate extends GuiContainer{
	...
	public GuiMRATActivate(InventoryPlayer inventory, TileEntityMRAT tile_entity, ItemStack item) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2){
        this.fontRendererObj.drawString(EnumChatFormatting.UNDERLINE + StatCollector.translateToLocal("gui.mrat.activate"), this.xSize / 2 - this.fontRendererObj.getStringWidth(StatCollector.translateToLocal("gui.mrat.deactivate")) / 2, 6, 4210752);
    }
