...
public class GuiKeycardSetup extends GuiContainer{
	...
	private void saveLvls() {
		...
		SecurityCraft.network.sendToServer(new PacketSetKeycardLevel(keypadInventory.xCoord, keypadInventory.yCoord, keypadInventory.zCoord, lvlOfSecurity, requiresExactCard));
