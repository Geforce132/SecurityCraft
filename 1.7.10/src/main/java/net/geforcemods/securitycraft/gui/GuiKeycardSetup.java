...
public class GuiKeycardSetup extends GuiContainer{
	...
	private void saveLVs() {
		...
		mod_SecurityCraft.network.sendToServer(new PacketSetKeycardLevel(keypadInventory.xCoord, keypadInventory.yCoord, keypadInventory.zCoord, lvlOfSecurity, requiresExactCard));
