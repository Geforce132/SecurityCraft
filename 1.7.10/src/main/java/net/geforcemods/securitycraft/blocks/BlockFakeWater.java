...
public class BlockFakeWater extends BlockDynamicLiquid{
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random){
		int l = func_149804_e(par1World, par2, par3, par4);
		byte b0 = 1;
		...
		if (l > 0){
			byte b1 = -100;
			field_149815_a = 0;
			int l1 = func_149810_a(par1World, par2 - 1, par3, par4, b1);
			l1 = func_149810_a(par1World, par2 + 1, par3, par4, l1);
			l1 = func_149810_a(par1World, par2, par3, par4 - 1, l1);
			l1 = func_149810_a(par1World, par2, par3, par4 + 1, l1);
			j1 = l1 + b0;
			...
			if (func_149804_e(par1World, par2, par3 + 1, par4) >= 0){
				int k1 = func_149804_e(par1World, par2, par3 + 1, par4);
			...
			if (j1 == l){
				if (flag)
					func_149811_n(par1World, par2, par3, par4);
			}else{
				l = j1;
		...
		if (func_149809_q(par1World, par2, par3 - 1, par4)){
	...
	protected int getSmallestFlowDecay(World par1World, int par2, int par3, int par4, int par5){
		int i1 = func_149804_e(par1World, par2, par3, par4);
