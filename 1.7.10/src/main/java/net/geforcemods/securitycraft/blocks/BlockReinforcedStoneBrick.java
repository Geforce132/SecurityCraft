...
public class BlockReinforcedStoneBrick extends BlockOwnable
{
	private static final String[] sideIconSuffixes = new String[] {"default", "mossy", "cracked", "chiseled"};
	...
	{
		icons = new IIcon[sideIconSuffixes.length];

		for(int i = 0; i < icons.length; i++)
		{
			icons[i] = par1IIconRegister.registerIcon(getTextureName() + "_" + sideIconSuffixes[i]);
		}
	}
}
