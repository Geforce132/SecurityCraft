...
public class ModelSentry extends ModelBase
{
	...
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		{
			GL11.glRotated(((EntitySentry)entity).getDataWatcher().getWatchableObjectFloat(EntitySentry.HEAD_ROTATION), 0.0F, 1.0F, 0.0F);
			GL11.glTranslatef(0.0F, ((EntitySentry)entity).getHeadYTranslation(), 0.0F);
		}
