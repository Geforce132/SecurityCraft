...
public class RegistrationHandler
{
	...
	public static void registerRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.claymoreActive, 1), new Object[]{
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStairsStone, 4), new Object[]{
				"S  ", "SS ", "SSS", 'S', SCContent.reinforcedStone
		});
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStairsSandstone, 4), new Object[]{
				"S  ", "SS ", "SSS", 'S', new ItemStack(SCContent.reinforcedSandstone, 1, 0)
		});
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStairsQuartz, 4), new Object[]{
				"S  ", "SS ", "SSS", 'S', new ItemStack(SCContent.reinforcedQuartz, 1, 0)
		});
		...
		for(int i = 0; i < 16; i++){
			GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStainedGlass, 8, BlockColored.func_150031_c(i)), new Object[]{
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStoneSlabs, 6, 0), new Object[]{
				"MMM", 'M', SCContent.reinforcedStone
		});
		...
		GameRegistry.addRecipe(new ItemStack(SCContent.reinforcedStoneSlabs, 7, 6), new Object[]{
