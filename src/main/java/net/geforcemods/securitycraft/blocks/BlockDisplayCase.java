...
public class BlockDisplayCase extends BlockOwnable {
	...
	public BlockDisplayCase(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			...
			if (te instanceof TileEntityDisplayCase) {
				TileEntityDisplayCase be = (TileEntityDisplayCase) te;
	...
	public void activate(TileEntityDisplayCase be) {
		be.setOpen(true);
	}
