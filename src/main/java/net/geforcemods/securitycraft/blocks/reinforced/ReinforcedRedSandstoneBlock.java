...
public class ReinforcedRedSandstoneBlock extends BlockRedSandstone implements ITileEntityProvider, IOverlayDisplay, IReinforcedBlock {
	private final float destroyTimeForOwner;

	public ReinforcedRedSandstoneBlock() {
		setBlockUnbreakable();
	...
	public ItemStack getDisplayStack(World world, IBlockState state, BlockPos pos) {
		return new ItemStack(Item.getItemFromBlock(SCContent.reinforcedRedSandstone), 1, getMetaFromState(state));
	}
