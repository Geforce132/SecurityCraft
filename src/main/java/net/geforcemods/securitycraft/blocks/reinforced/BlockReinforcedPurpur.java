...
public class BlockReinforcedPurpur extends BlockOwnable implements ICustomWailaDisplay, IReinforcedBlock
{
	...
	{
		BlockReinforcedPurpur.EnumType type = state.getValue(VARIANT);
		return type != BlockReinforcedPurpur.EnumType.LINES_X && type != BlockReinforcedPurpur.EnumType.LINES_Z ? super.getSilkTouchDrop(state) : new ItemStack(Item.getItemFromBlock(this), 1, BlockReinforcedPurpur.EnumType.LINES_Y.getMetadata());
	}
