...
public class ReinforcedConcreteBlock extends BlockColored implements ITileEntityProvider, IOverlayDisplay, IReinforcedBlock {
	...
	public ItemStack getDisplayStack(World world, IBlockState state, BlockPos pos) {
		return new ItemStack(Item.getItemFromBlock(SCContent.reinforcedConcrete), 1, getMetaFromState(state));
	}
