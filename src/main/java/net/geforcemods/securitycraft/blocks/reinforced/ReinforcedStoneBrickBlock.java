...
public class ReinforcedStoneBrickBlock extends BlockStoneBrick implements ITileEntityProvider, IOverlayDisplay, IReinforcedBlock {
	private final float destroyTimeForOwner;

	public ReinforcedStoneBrickBlock() {
		setBlockUnbreakable();
