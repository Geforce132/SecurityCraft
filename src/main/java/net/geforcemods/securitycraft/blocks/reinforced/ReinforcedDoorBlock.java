...
public class ReinforcedDoorBlock extends OwnableBlock {
	...
	public ReinforcedDoorBlock(Material material) {
		super(Block.Properties.create(material).hardnessAndResistance(-1.0F, 6000000.0F).sound(SoundType.METAL).notSolid());
	...
	private DoorHingeSide getHingeSide(BlockItemUseContext p_208073_1_) {
		...
		int i = (blockstate.func_235785_r_(iblockreader, blockpos2) ? -1 : 0) + (blockstate1.func_235785_r_(iblockreader, blockpos3) ? -1 : 0) + (blockstate2.func_235785_r_(iblockreader, blockpos4) ? 1 : 0) + (blockstate3.func_235785_r_(iblockreader, blockpos5) ? 1 : 0); //isCollisionShapeOpaque
