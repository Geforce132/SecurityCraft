...
public class ReinforcedMagmaBlock extends BaseReinforcedBlock {
	...
	public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
		if (!entity.fireImmune() && entity instanceof LivingEntity lEntity && !EnchantmentHelper.hasFrostWalker(lEntity) && level.getBlockEntity(pos) instanceof OwnableBlockEntity ownable && !ownable.isOwnedBy(entity))
