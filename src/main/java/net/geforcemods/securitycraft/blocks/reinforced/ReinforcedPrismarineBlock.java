...
public class ReinforcedPrismarineBlock extends BlockPrismarine implements ITileEntityProvider, IOverlayDisplay, IReinforcedBlock {
	private final float destroyTimeForOwner;

	public ReinforcedPrismarineBlock() {
		setBlockUnbreakable();
	...
	public ItemStack getDisplayStack(World world, IBlockState state, BlockPos pos) {
		return new ItemStack(Item.getItemFromBlock(SCContent.reinforcedPrismarine), 1, getMetaFromState(state));
	}
