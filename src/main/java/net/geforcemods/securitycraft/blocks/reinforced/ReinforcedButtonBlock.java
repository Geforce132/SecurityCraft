...
public class ReinforcedButtonBlock extends AbstractButtonBlock implements IReinforcedBlock
{
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult p_225533_6_) {
        ...
        else if (tileEntity instanceof ReinforcedButtonTileEntity && isAllowedToPress(world, pos, (ReinforcedButtonTileEntity) tileEntity, player))
        {
    ...
    public boolean isAllowedToPress(World world, BlockPos pos, ReinforcedButtonTileEntity te, PlayerEntity entity)
    {
