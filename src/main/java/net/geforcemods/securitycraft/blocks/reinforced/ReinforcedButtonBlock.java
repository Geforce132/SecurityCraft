...
public class ReinforcedButtonBlock extends ButtonBlock implements IReinforcedBlock, EntityBlock {
	...
	public ReinforcedButtonBlock(BlockBehaviour.Properties properties, Block vb, int ticksToStayPressed, boolean arrowsCanPush, SoundEvent soundOff, SoundEvent soundOn) {
