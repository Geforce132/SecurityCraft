...
public class KeycardLockFloorCeilingBlock extends KeycardLockBlock {
	...
	static {
		...
		FLOOR_NS = new AxisAlignedBB(4 * px, 0 * px, 3 * px, 12 * px, 3 * px, 13 * px);
		FLOOR_EW = new AxisAlignedBB(3 * px, 0 * px, 4 * px, 13 * px, 3 * px, 12 * px);
		CEILING_NS = new AxisAlignedBB(4 * px, 13 * px, 3 * px, 12 * px, 16 * px, 13 * px);
		CEILING_EW = new AxisAlignedBB(3 * px, 13 * px, 4 * px, 13 * px, 16 * px, 12 * px);
	}
