...
public class IronFenceBlock extends OwnableBlock {
	...
	public BlockState getStateForPlacement(BlockItemUseContext ctx) {
		...
		return super.getStateForPlacement(ctx).setValue(NORTH, connectsTo(blockstate, Block.isFaceSturdy(blockstate, iblockreader, blockpos1, Direction.SOUTH), Direction.SOUTH)).setValue(EAST, connectsTo(blockstate1, Block.isFaceSturdy(blockstate1, iblockreader, blockpos2, Direction.WEST), Direction.WEST)).setValue(SOUTH, connectsTo(blockstate2, Block.isFaceSturdy(blockstate2, iblockreader, blockpos3, Direction.NORTH), Direction.NORTH)).setValue(WEST, connectsTo(blockstate3, Block.isFaceSturdy(blockstate3, iblockreader, blockpos4, Direction.EAST), Direction.EAST));
	}
	...
	public BlockState updateShape(BlockState state, Direction facing, BlockState facingState, IWorld world, BlockPos currentPos, BlockPos facingPos) {
		return facing.getAxis().getPlane() == Direction.Plane.HORIZONTAL ? state.setValue(FACING_TO_PROPERTY_MAP.get(facing), connectsTo(facingState, Block.isFaceSturdy(facingState, world, facingPos, facing.getOpposite()), facing.getOpposite())) : super.updateShape(state, facing, facingState, world, currentPos, facingPos);
	}
