...
public class BlockPortableRadar extends ContainerBlock {
	...
	public TileEntity createNewTileEntity(IBlockReader world) {
		return new TileEntityPortableRadar().attacks(PlayerEntity.class, CommonConfig.CONFIG.portableRadarSearchRadius.get(), CommonConfig.CONFIG.portableRadarDelay.get()).nameable();
	}
