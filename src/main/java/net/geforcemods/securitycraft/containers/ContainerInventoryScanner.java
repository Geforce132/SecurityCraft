...
public class ContainerInventoryScanner extends Container {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int index)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			else if (!mergeItemStack(slotStack, 10, numRows * 9, false))
				return null;
	...
	public void onContainerClosed(EntityPlayer player)
	{
		...
		Utils.setISinTEAppropriately(player.worldObj, inventoryScannerTE.getPos(), ((TileEntityInventoryScanner) player.worldObj.getTileEntity(inventoryScannerTE.getPos())).getContents(), ((TileEntityInventoryScanner) player.worldObj.getTileEntity(inventoryScannerTE.getPos())).getType());
	}
