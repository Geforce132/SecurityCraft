...
public class CopyPositionComponentItemRecipe extends CombineRecipe {
	...
	public CopyPositionComponentItemRecipe(ResourceLocation id, Item item, Predicate<CompoundTag> hasData, RecipeSerializer<? extends CustomRecipe> serializer) {
		super(id);
		this.item = item;
	...
	public static CopyPositionComponentItemRecipe cameraMonitor(ResourceLocation id) {
		return new CopyPositionComponentItemRecipe(id, SCContent.CAMERA_MONITOR.get(), CameraMonitorItem::hasCameraAdded, SCContent.COPY_CAMERA_MONITOR_RECIPE_SERIALIZER.get());
	}

	public static CopyPositionComponentItemRecipe mineRemoteAccessTool(ResourceLocation id) {
		return new CopyPositionComponentItemRecipe(id, SCContent.MINE_REMOTE_ACCESS_TOOL.get(), MineRemoteAccessToolItem::hasMineAdded, SCContent.COPY_MINE_REMOTE_ACCESS_TOOL_RECIPE_SERIALIZER.get());
	}

	public static CopyPositionComponentItemRecipe sentryRemoteAccessTool(ResourceLocation id) {
		return new CopyPositionComponentItemRecipe(id, SCContent.SENTRY_REMOTE_ACCESS_TOOL.get(), SentryRemoteAccessToolItem::hasSentryAdded, SCContent.COPY_SENTRY_REMOTE_ACCESS_TOOL_RECIPE_SERIALIZER.get());
	}

	public static CopyPositionComponentItemRecipe sonicSecuritySystem(ResourceLocation id) {
		return new CopyPositionComponentItemRecipe(id, SCContent.SONIC_SECURITY_SYSTEM_ITEM.get(), SonicSecuritySystemItem::hasLinkedBlock, SCContent.COPY_SONIC_SECURITY_SYSTEM_RECIPE_SERIALIZER.get());
	}
