...
public class BlockTagGenerator extends BlockTagsProvider
{
	...
	protected void registerTags()
	{
		...
		//forge tags
		getBuilder(Tags.Blocks.SUPPORTS_BEACON).add(SCContent.REINFORCED_IRON_BLOCK.get(), SCContent.REINFORCED_GOLD_BLOCK.get(), SCContent.REINFORCED_DIAMOND_BLOCK.get(), SCContent.REINFORCED_EMERALD_BLOCK.get());
		getBuilder(Tags.Blocks.SUPPORTS_CONDUIT).add(SCContent.REINFORCED_PRISMARINE.get(), SCContent.REINFORCED_PRISMARINE_BRICKS.get(), SCContent.REINFORCED_SEA_LANTERN.get(), SCContent.REINFORCED_DARK_PRISMARINE.get());
	}
