...
public class ProjectECompatConversionProvider extends CustomConversionProvider {
	...
	protected void addCustomConversions() {
		CustomConversionBuilder reinforcedBlocksconversionBuilder = createConversionBuilder(new net.minecraft.util.ResourceLocation(SecurityCraft.MODID, "reinforced_blocks"));
