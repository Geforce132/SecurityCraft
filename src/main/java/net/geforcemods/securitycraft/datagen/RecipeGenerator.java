...
public class RecipeGenerator extends RecipeProvider {
	...
	protected final void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		.unlocks("has_redstone", has(Tags.Items.DUSTS_REDSTONE))
		.save(consumer);
		...
		.unlocks("has_redstone_block", has(Tags.Items.STORAGE_BLOCKS_REDSTONE))
		.save(consumer);
		...
		.unlocks("has_lava_bucket", has(Items.LAVA_BUCKET))
		...
		.unlocks("has_water_bucket", has(Items.WATER_BUCKET))
		...
		.unlocks("has_prismarine_crystals", has(Tags.Items.GEMS_PRISMARINE))
		.save(consumer);
		ShapedRecipeBuilder.shaped(SCContent.CRYSTAL_QUARTZ.get())
		.pattern("CC")
		.pattern("CC")
		.define('C', SCContent.CRYSTAL_QUARTZ_ITEM.get())
		.unlocks("has_crystal_quartz_item", has(SCContent.CRYSTAL_QUARTZ_ITEM.get()))
		.save(consumer);
		...
		.define('I', SCContent.REINFORCED_IRON_BLOCK.get())
		.unlocks("has_radar", has(SCContent.PORTABLE_RADAR.get()))
		.save(consumer);
		...
		.unlocks("has_stone", has(SCTags.Items.REINFORCED_STONE))
		.save(consumer);
		...
		.unlocks("has_stone_button", has(Items.STONE_BUTTON))
		.save(consumer);
		...
		.unlocks("has_stone", has(Tags.Items.STONE))
		.save(consumer);
		...
		.define('S', Tags.Items.RODS_WOODEN)
		.unlocks("has_stick", has(Tags.Items.RODS_WOODEN))
		.save(consumer);
		...
		.unlocks("has_redstone_lamp", has(SCContent.REINFORCED_REDSTONE_LAMP.get()))
		.save(consumer);
		...
		.unlocks("has_book", has(Items.BOOK))
		.save(consumer);
		...
		.unlocks("has_reinforced_gravel", has(SCContent.REINFORCED_GRAVEL.get()))
		.save(consumer);
		...
		.define('Q', Tags.Items.GEMS_QUARTZ)
		.unlocks("has_cobblestone", has(Tags.Items.COBBLESTONE))
		.save(consumer);
		...
		.unlocks("has_cobble", has(SCContent.REINFORCED_COBBLESTONE.get()))
		.save(consumer);
		...
		.define('Q', Tags.Items.GEMS_QUARTZ)
		.define('R', Tags.Items.DUSTS_REDSTONE)
		.unlocks("has_quartz", has(Tags.Items.GEMS_QUARTZ))
		.save(consumer);
		...
		.define('G', Tags.Items.INGOTS_GOLD)
		.define('S', Tags.Items.RODS_WOODEN)
		.unlocks("has_mine", has(SCContent.MINE.get()))
		.save(consumer);
		...
		.define('D', Tags.Items.GEMS_DIAMOND)
		.define('S', Tags.Items.RODS_WOODEN)
		.unlocks("has_sentry", has(SCContent.SENTRY.get()))
		.save(consumer);
		...
		.pattern("GGG")
		.define('G', SCContent.REINFORCED_GLASS.get())
		.unlocks("has_glass", has(Tags.Items.GLASS))
		.save(consumer);
		...
		.unlocks("has_reinforced_crystal_quartz", has(SCContent.REINFORCED_CRYSTAL_QUARTZ.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_door", has(SCContent.REINFORCED_DOOR_ITEM.get()))
		.save(consumer);
		...
		.unlocks("has_block_pocket_wall", has(SCContent.BLOCK_POCKET_WALL.get()))
		.save(consumer);
		...
		.unlocks("has_wood", has(ItemTags.LOGS)) //the thought behind this is that the recipe will be given right after the player chopped their first piece of wood
		.save(consumer);
		...
		.unlocks("has_name_tag", has(Items.NAME_TAG))
		.save(consumer);
		...
		.unlocks("has_reinforced_cobblestone", has(SCContent.REINFORCED_COBBLESTONE.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_quartz", has(SCContent.REINFORCED_QUARTZ.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_red_sandstone", has(SCContent.REINFORCED_RED_SANDSTONE.get()))
		.save(consumer);
		CookingRecipeBuilder.smelting(Ingredient.of(SCTags.Items.REINFORCED_SAND), SCContent.REINFORCED_GLASS.get(), 0.1F, 200)
		.unlocks("has_reinforced_sand", has(SCContent.REINFORCED_SAND.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_sandstone", has(SCContent.REINFORCED_SANDSTONE.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_stone", has(SCContent.REINFORCED_STONE.get()))
		.save(consumer);
		...
		.unlocks("has_reinforced_stone_bricks", has(SCContent.REINFORCED_STONE_BRICKS.get()))
		.save(consumer);
		CookingRecipeBuilder.smelting(Ingredient.of(SCContent.REINFORCED_CLAY.get()), SCContent.REINFORCED_TERRACOTTA.get(), 0.35F, 200)
		.unlocks("has_reinforced_clay", has(SCContent.REINFORCED_CLAY.get()))
		.save(consumer);
	...
	protected final void addCarpetRecipe(Consumer<IFinishedRecipe> consumer, IItemProvider wool, IItemProvider carpet) {
		...
		.pattern("WW")
		.define('W', wool)
		.unlocks("has_wool", has(SCTags.Items.REINFORCED_WOOL))
		.save(consumer);
	}
	...
	protected final void addColoredWoolRecipe(Consumer<IFinishedRecipe> consumer, Tag<Item> dye, IItemProvider result) {
		...
		.unlocks("has_wool", has(SCContent.REINFORCED_WHITE_WOOL.get()))
		.save(consumer);
		//@formatter:on
	}
	...
	protected final void addKeycardResetRecipe(Consumer<IFinishedRecipe> consumer, IItemProvider keycard) {
		...
		.requires(keycard)
		.unlocks("has_keycard", has(keycard))
	...
	protected final void addStainedTerracottaRecipe(Consumer<IFinishedRecipe> consumer, Tag<Item> dye, IItemProvider result) {
		...
		.define('D', dye)
		.unlocks("has_reinforced_terracotta", has(SCContent.REINFORCED_TERRACOTTA.get()))
		.save(consumer);
		//@formatter:on
	}
