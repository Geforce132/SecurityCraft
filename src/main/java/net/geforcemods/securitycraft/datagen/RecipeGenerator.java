...
public class RecipeGenerator extends RecipeProvider {
	...
	protected final void buildRecipes() {
		...
		addChiselingRecipe(SCContent.REINFORCED_CINNABAR_SLAB, SCContent.REINFORCED_CHISELED_CINNABAR);
		...
		addChiselingRecipe(SCContent.REINFORCED_SULFUR_SLAB, SCContent.REINFORCED_CHISELED_SULFUR);
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER_SLAB, SCContent.REINFORCED_CHISELED_COPPER, this::addChiselingRecipe);
		...
		addSlabRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_SLAB);
		addSlabRecipe(SCContent.REINFORCED_CINNABAR_BRICKS, SCContent.REINFORCED_CINNABAR_BRICK_SLAB);
		...
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER, SCContent.REINFORCED_CUT_COPPER_SLAB, this::addSlabRecipe);
		...
		addSlabRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_SLAB);
		...
		addSlabRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_SLAB);
		...
		addSlabRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_SLAB);
		addSlabRecipe(SCContent.REINFORCED_SULFUR_BRICKS, SCContent.REINFORCED_SULFUR_BRICK_SLAB);
		...
		addStairsRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_STAIRS);
		addStairsRecipe(SCContent.REINFORCED_CINNABAR_BRICKS, SCContent.REINFORCED_CINNABAR_BRICK_STAIRS);
		...
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER, SCContent.REINFORCED_CUT_COPPER_STAIRS, this::addStairsRecipe);
		...
		addStairsRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_STAIRS);
		...
		addStairsRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_STAIRS);
		...
		addStairsRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_STAIRS);
		addStairsRecipe(SCContent.REINFORCED_SULFUR_BRICKS, SCContent.REINFORCED_SULFUR_BRICK_STAIRS);
		...
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_CUT_COPPER, this::addTwoByTwoRecipe);
		...
		addWallRecipes(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_WALL);
		addWallRecipes(SCContent.REINFORCED_CINNABAR_BRICKS, SCContent.REINFORCED_CINNABAR_BRICK_WALL);
		...
		addWallRecipes(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_WALL);
		addWallRecipes(SCContent.REINFORCED_POLISHED_DEEPSLATE, SCContent.REINFORCED_POLISHED_DEEPSLATE_WALL);
		addWallRecipes(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_WALL);
		...
		addWallRecipes(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_WALL);
		addWallRecipes(SCContent.REINFORCED_SULFUR_BRICKS, SCContent.REINFORCED_SULFUR_BRICK_WALL);
		...
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_CUT_COPPER, (block, cut) -> addStonecuttingRecipe(block, cut, 4));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_CUT_COPPER_SLAB, (block, cut) -> addStonecuttingRecipe(block, cut, 8));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_CUT_COPPER_STAIRS, (block, cut) -> addStonecuttingRecipe(block, cut, 4));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_CHISELED_COPPER, (block, cut) -> addStonecuttingRecipe(block, cut, 4));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_COPPER_BLOCK, SCContent.REINFORCED_COPPER_GRATE, (block, cut) -> addStonecuttingRecipe(block, cut, 4));
		...
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER, SCContent.REINFORCED_CUT_COPPER_SLAB, (block, cut) -> addStonecuttingRecipe(block, cut, 2));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER, SCContent.REINFORCED_CUT_COPPER_STAIRS, (block, cut) -> addStonecuttingRecipe(block, cut, 1));
		WeatheringCopperCollection.zipApply(SCContent.REINFORCED_CUT_COPPER, SCContent.REINFORCED_CHISELED_COPPER, (block, cut) -> addStonecuttingRecipe(block, cut, 1));
		...
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_BRICKS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR, SCContent.REINFORCED_CHISELED_SULFUR, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_POLISHED_SULFUR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_SULFUR_BRICKS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_SULFUR, SCContent.REINFORCED_SULFUR_BRICK_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR_BRICKS, SCContent.REINFORCED_SULFUR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_SULFUR_BRICKS, SCContent.REINFORCED_SULFUR_BRICK_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICKS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR, SCContent.REINFORCED_CHISELED_CINNABAR, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_POLISHED_CINNABAR_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICKS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_STAIRS, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_POLISHED_CINNABAR, SCContent.REINFORCED_CINNABAR_BRICK_WALL, 1);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR_BRICKS, SCContent.REINFORCED_CINNABAR_BRICK_SLAB, 2);
		addStonecuttingRecipe(SCContent.REINFORCED_CINNABAR_BRICKS, SCContent.REINFORCED_CINNABAR_BRICK_STAIRS, 1);
