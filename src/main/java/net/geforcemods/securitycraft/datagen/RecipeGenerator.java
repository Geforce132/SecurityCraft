...
public class RecipeGenerator extends RecipeProvider {
	...
	protected final void buildRecipes(RecipeOutput recipeOutput) {
		...
		//tool copying
		SpecialRecipeBuilder.special(CopyPositionComponentItemRecipe::cameraMonitor).save(recipeOutput, SecurityCraft.resLoc("copy_camera_monitor"));
		SpecialRecipeBuilder.special(CopyPositionComponentItemRecipe::mineRemoteAccessTool).save(recipeOutput, SecurityCraft.resLoc("copy_mine_remote_access_tool"));
		SpecialRecipeBuilder.special(CopyPositionComponentItemRecipe::sentryRemoteAccessTool).save(recipeOutput, SecurityCraft.resLoc("copy_sentry_remote_access_tool"));
		SpecialRecipeBuilder.special(CopyPositionComponentItemRecipe::sonicSecuritySystem).save(recipeOutput, SecurityCraft.resLoc("copy_sonic_security_system"));
		...
		.save(recipeOutput);
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, SCContent.INCOGNITO_MASK)
		.pattern(" S ")
		.pattern("S S")
		.pattern(" L ")
		.define('S', Tags.Items.STRINGS)
		...
		.unlockedBy("has_radar", has(SCContent.PORTABLE_RADAR))
		.save(recipeOutput);
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, SCContent.SECURE_TRADING_STATION)
		.pattern("GGG")
		.pattern("GHG")
		.pattern("SRS")
		.define('G', SCContent.REINFORCED_GLASS)
