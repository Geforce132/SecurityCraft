...
public class BlockModelAndStateGenerator extends BlockStateProvider {
	private static final Map<Direction, EnumProperty<WallHeight>> DIR_TO_WALL_HEIGHT = ImmutableMap.of(Direction.EAST, BlockStateProperties.WALL_HEIGHT_EAST, Direction.NORTH, BlockStateProperties.WALL_HEIGHT_NORTH, Direction.SOUTH, BlockStateProperties.WALL_HEIGHT_SOUTH, Direction.WEST, BlockStateProperties.WALL_HEIGHT_WEST);
