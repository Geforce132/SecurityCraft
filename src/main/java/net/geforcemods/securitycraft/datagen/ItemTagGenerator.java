...
public class ItemTagGenerator extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(Tags.Items.DYED_BLACK).add(SCContent.REINFORCED_BLACK_CARPET.get().asItem(), SCContent.REINFORCED_BLACK_CONCRETE.get().asItem(), SCContent.REINFORCED_BLACK_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BLACK_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_BLACK_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_BLACK_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BLACK_WOOL.get().asItem());
		tag(Tags.Items.DYED_BLUE).add(SCContent.REINFORCED_BLUE_CARPET.get().asItem(), SCContent.REINFORCED_BLUE_CONCRETE.get().asItem(), SCContent.REINFORCED_BLUE_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BLUE_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_BLUE_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_BLUE_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BLUE_WOOL.get().asItem());
		tag(Tags.Items.DYED_BROWN).add(SCContent.REINFORCED_BROWN_CARPET.get().asItem(), SCContent.REINFORCED_BROWN_CONCRETE.get().asItem(), SCContent.REINFORCED_BROWN_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BROWN_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_BROWN_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_BROWN_TERRACOTTA.get().asItem(), SCContent.REINFORCED_BROWN_WOOL.get().asItem());
		tag(Tags.Items.DYED_CYAN).add(SCContent.REINFORCED_CYAN_CARPET.get().asItem(), SCContent.REINFORCED_CYAN_CONCRETE.get().asItem(), SCContent.REINFORCED_CYAN_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_CYAN_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_CYAN_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_CYAN_TERRACOTTA.get().asItem(), SCContent.REINFORCED_CYAN_WOOL.get().asItem());
		tag(Tags.Items.DYED_GRAY).add(SCContent.REINFORCED_GRAY_CARPET.get().asItem(), SCContent.REINFORCED_GRAY_CONCRETE.get().asItem(), SCContent.REINFORCED_GRAY_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_GRAY_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_GRAY_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_GRAY_TERRACOTTA.get().asItem(), SCContent.REINFORCED_GRAY_WOOL.get().asItem());
		tag(Tags.Items.DYED_GREEN).add(SCContent.REINFORCED_GREEN_CARPET.get().asItem(), SCContent.REINFORCED_GREEN_CONCRETE.get().asItem(), SCContent.REINFORCED_GREEN_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_GREEN_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_GREEN_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_GREEN_TERRACOTTA.get().asItem(), SCContent.REINFORCED_GREEN_WOOL.get().asItem());
		tag(Tags.Items.DYED_LIGHT_BLUE).add(SCContent.REINFORCED_LIGHT_BLUE_CARPET.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_CONCRETE.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIGHT_BLUE_WOOL.get().asItem());
		tag(Tags.Items.DYED_LIGHT_GRAY).add(SCContent.REINFORCED_LIGHT_GRAY_CARPET.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_CONCRETE.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIGHT_GRAY_WOOL.get().asItem());
		tag(Tags.Items.DYED_LIME).add(SCContent.REINFORCED_LIME_CARPET.get().asItem(), SCContent.REINFORCED_LIME_CONCRETE.get().asItem(), SCContent.REINFORCED_LIME_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIME_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_LIME_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_LIME_TERRACOTTA.get().asItem(), SCContent.REINFORCED_LIME_WOOL.get().asItem());
		tag(Tags.Items.DYED_MAGENTA).add(SCContent.REINFORCED_MAGENTA_CARPET.get().asItem(), SCContent.REINFORCED_MAGENTA_CONCRETE.get().asItem(), SCContent.REINFORCED_MAGENTA_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_MAGENTA_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_MAGENTA_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_MAGENTA_TERRACOTTA.get().asItem(), SCContent.REINFORCED_MAGENTA_WOOL.get().asItem());
		tag(Tags.Items.DYED_ORANGE).add(SCContent.REINFORCED_ORANGE_CARPET.get().asItem(), SCContent.REINFORCED_ORANGE_CONCRETE.get().asItem(), SCContent.REINFORCED_ORANGE_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_ORANGE_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_ORANGE_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_ORANGE_TERRACOTTA.get().asItem(), SCContent.REINFORCED_ORANGE_WOOL.get().asItem());
		tag(Tags.Items.DYED_PURPLE).add(SCContent.REINFORCED_PURPLE_CARPET.get().asItem(), SCContent.REINFORCED_PURPLE_CONCRETE.get().asItem(), SCContent.REINFORCED_PURPLE_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_PURPLE_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_PURPLE_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_PURPLE_TERRACOTTA.get().asItem(), SCContent.REINFORCED_PURPLE_WOOL.get().asItem());
		tag(Tags.Items.DYED_PINK).add(SCContent.REINFORCED_PINK_CARPET.get().asItem(), SCContent.REINFORCED_PINK_CONCRETE.get().asItem(), SCContent.REINFORCED_PINK_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_PINK_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_PINK_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_PINK_TERRACOTTA.get().asItem(), SCContent.REINFORCED_PINK_WOOL.get().asItem());
		tag(Tags.Items.DYED_RED).add(SCContent.REINFORCED_RED_CARPET.get().asItem(), SCContent.REINFORCED_RED_CONCRETE.get().asItem(), SCContent.REINFORCED_RED_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_RED_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_RED_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_RED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_RED_WOOL.get().asItem());
		tag(Tags.Items.DYED_WHITE).add(SCContent.REINFORCED_WHITE_CARPET.get().asItem(), SCContent.REINFORCED_WHITE_CONCRETE.get().asItem(), SCContent.REINFORCED_WHITE_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_WHITE_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_WHITE_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_WHITE_TERRACOTTA.get().asItem(), SCContent.REINFORCED_WHITE_WOOL.get().asItem());
		tag(Tags.Items.DYED_YELLOW).add(SCContent.REINFORCED_YELLOW_CARPET.get().asItem(), SCContent.REINFORCED_YELLOW_CONCRETE.get().asItem(), SCContent.REINFORCED_YELLOW_GLAZED_TERRACOTTA.get().asItem(), SCContent.REINFORCED_YELLOW_STAINED_GLASS.get().asItem(), SCContent.REINFORCED_YELLOW_STAINED_GLASS_PANE.get().asItem(), SCContent.REINFORCED_YELLOW_TERRACOTTA.get().asItem(), SCContent.REINFORCED_YELLOW_WOOL.get().asItem());
