...
public enum CameraRedstoneModuleState {
	NOT_INSTALLED((gui, x, y) -> {
		Minecraft.getMinecraft().getTextureManager().bindTexture(GuiUtils.CAMERA_DASHBOARD);
	...
	ACTIVATED((gui, x, y) -> GuiUtils.drawItemStackToGui(GuiUtils.REDSTONE, x - 2, y - 2, false));
