...
public class ReinforcedCauldronInteractions {
	...
	public static void onRegisterCauldronInteractionInteractions(RegisterCauldronInteractionEvent.Interaction event) {
		...
		event.register(water, Items.BANNER.white(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.gray(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.black(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.blue(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.brown(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.cyan(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.green(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.lightBlue(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.lightGray(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.lime(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.magenta(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.orange(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.pink(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.purple(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.red(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.BANNER.yellow(), ReinforcedCauldronInteractions::bannerInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.white(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.gray(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.black(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.blue(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.brown(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.cyan(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.green(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.lightBlue(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.lightGray(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.lime(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.magenta(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.orange(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.pink(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.purple(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.red(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
		event.register(water, Items.DYED_SHULKER_BOX.yellow(), ReinforcedCauldronInteractions::shulkerBoxInteraction);
