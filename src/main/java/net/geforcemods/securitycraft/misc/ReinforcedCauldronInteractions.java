...
public class ReinforcedCauldronInteractions {
	...
	public static void onRegisterCauldronInteractionInteractions(RegisterCauldronInteractionEvent.Interaction event) {
		...
		Items.BANNER.forEach(item -> event.register(water, item, ReinforcedCauldronInteractions::bannerInteraction));
		Items.DYED_SHULKER_BOX.forEach(item -> event.register(water, item, ReinforcedCauldronInteractions::shulkerBoxInteraction));
