...
public class RegistrationHandler {
		...
		for (Field field : SCContent.class.getFields()) {
			try {
				if (field.isAnnotationPresent(Reinforced.class) && field.getAnnotation(Reinforced.class).registerBlockItem()) {
					...
					event.getRegistry().register(new BlockItem(block, new Item.Properties().group(SecurityCraft.groupSCDecoration)).setRegistryName(block.getRegistryName()));
				}
	...
	public static void registerTileEntities(RegistryEvent.Register<TileEntityType<?>> event) {
		...
		event.getRegistry().register(TileEntityType.Builder.create(KeypadSmokerTileEntity::new, SCContent.KEYPAD_SMOKER.get()).build(null).setRegistryName(new ResourceLocation(SecurityCraft.MODID, "keypad_smoker")));
		event.getRegistry().register(TileEntityType.Builder.create(KeypadBlastFurnaceTileEntity::new, SCContent.KEYPAD_BLAST_FURNACE.get()).build(null).setRegistryName(new ResourceLocation(SecurityCraft.MODID, "keypad_blast_furnace")));
	...
	public static void registerContainers(RegistryEvent.Register<ContainerType<?>> event) {
		...
		event.getRegistry().register(IForgeContainerType.create((windowId, inv, data) -> new KeypadSmokerContainer(windowId, inv.player.world, data.readBlockPos(), inv)).setRegistryName(new ResourceLocation(SecurityCraft.MODID, "keypad_smoker")));
		event.getRegistry().register(IForgeContainerType.create((windowId, inv, data) -> new KeypadBlastFurnaceContainer(windowId, inv.player.world, data.readBlockPos(), inv)).setRegistryName(new ResourceLocation(SecurityCraft.MODID, "keypad_blast_furnace")));
