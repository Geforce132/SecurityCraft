...
public class RegistrationHandler {
	...
	public static void registerPackets(RegisterPayloadHandlerEvent event) {
		...
		clientPacket(registrar, InteractWithFrame.ID, InteractWithFrame::new, InteractWithFrame::handle);
		...
		serverPacket(registrar, SyncFrame.ID, SyncFrame::new, SyncFrame::handle);
		...
		serverPacket(registrar, SyncSecureRedstoneInterface.ID, SyncSecureRedstoneInterface::new, SyncSecureRedstoneInterface::handle);
	...
	public static void onCreativeModeTabRegister(BuildCreativeModeTabContentsEvent event) {
		...
		if (tabKey.equals(CreativeModeTabs.REDSTONE_BLOCKS)) {
			...
			entries.putAfter(new ItemStack(SCContent.REINFORCED_LECTERN.get()), new ItemStack(SCContent.SECRET_OAK_SIGN_ITEM.get()), TabVisibility.PARENT_AND_SEARCH_TABS);
	...
	private static Ingredient getPotionIngredient(Potion normalPotion, Potion strongPotion) {
		...
		NBTIngredient normalPotions;
		NBTIngredient strongPotions;
		...
		normalPotions = NBTIngredient.of(false, normalNBT, Items.POTION, Items.SPLASH_POTION, Items.LINGERING_POTION);
		strongPotions = NBTIngredient.of(false, strongNBT, Items.POTION, Items.SPLASH_POTION, Items.LINGERING_POTION);
