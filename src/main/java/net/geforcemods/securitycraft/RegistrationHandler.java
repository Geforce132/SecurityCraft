...
public class RegistrationHandler {
	...
	public static void registerPackets() {
		...
		//client
		registerPacket(id++, InteractWithFrame.class, InteractWithFrame::encode, InteractWithFrame::new, InteractWithFrame::handle);
		...
		registerPacket(id++, ToggleAlarmSound.class, ToggleAlarmSound::encode, ToggleAlarmSound::new, ToggleAlarmSound::handle);
		...
		registerPacket(id++, RequestSecureTradingStationTransactions.class, RequestSecureTradingStationTransactions::encode, RequestSecureTradingStationTransactions::new, RequestSecureTradingStationTransactions::handle);
		...
		registerPacket(id++, SyncFrame.class, SyncFrame::encode, SyncFrame::new, SyncFrame::handle);
