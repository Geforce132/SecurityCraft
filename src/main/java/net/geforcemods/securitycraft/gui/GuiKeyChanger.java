...
public class GuiKeyChanger extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
		fontRendererObj.drawString(ClientUtils.localize("item.securitycraft:universalKeyChanger.name"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("item.securitycraft:universalKeyChanger.name")) / 2, 6, 4210752);
		fontRendererObj.drawString(ClientUtils.localize("gui.securitycraft:universalKeyChanger.enterNewPasscode"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("gui.securitycraft:universalKeyChanger.enterNewPasscode")) / 2, 25, 4210752);
		fontRendererObj.drawString(ClientUtils.localize("gui.securitycraft:universalKeyChanger.confirmNewPasscode"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("gui.securitycraft:universalKeyChanger.confirmNewPasscode")) / 2, 65, 4210752);
	}
	...
	protected void actionPerformed(GuiButton button){
		switch(button.id){
			case 0:
				...
				PlayerUtils.sendMessageToPlayer(Minecraft.getMinecraft().thePlayer, ClientUtils.localize("item.securitycraft:universalKeyChanger.name"), ClientUtils.localize("messages.securitycraft:universalKeyChanger.passcodeChanged"), TextFormatting.GREEN);
		}
	}
