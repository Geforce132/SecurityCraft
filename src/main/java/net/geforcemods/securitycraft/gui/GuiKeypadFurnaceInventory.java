...
public class GuiKeypadFurnaceInventory extends GuiContainer{
	...
	{
		String s = gurnace ? "Keypad Gurnace" : (tileFurnace.hasCustomName() ? tileFurnace.getName() : ClientUtils.localize(ClientUtils.localize("gui.securitycraft:protectedFurnace.name")));
