...
public class GuiLaser extends GuiScreen {
	...
	private TileEntityLaserBlock be;
	private EnumMap<EnumFacing, Boolean> sideConfig;

	public GuiLaser(TileEntityLaserBlock be, EnumMap<EnumFacing, Boolean> sideConfig) {
		title = Utils.localize(SCContent.laserBlock).getFormattedText();
		this.be = be;
		this.sideConfig = sideConfig;
		hasSmartModule = be.isModuleEnabled(EnumModuleType.SMART);
	}
