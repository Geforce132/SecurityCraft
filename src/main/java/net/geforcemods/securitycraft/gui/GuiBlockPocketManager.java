...
public class GuiBlockPocketManager extends ContainerScreen<ContainerTEGeneric>
{
	...
	public GuiBlockPocketManager(ContainerTEGeneric container, PlayerInventory inv, ITextComponent name)
	{
		super(container, inv, name);

		te = (TileEntityBlockPocketManager)container.te;
		size = te.size;
	}
	...
	public void init()
	{
		...
		addButton(toggleButton = new GuiButtonClick(0, guiLeft + xSize / 2 - 45, guiTop + ySize / 2 - 10, 90, 20, ClientUtils.localize("gui.securitycraft:blockPocketManager." + (!te.enabled ? "activate" : "deactivate")), this::toggleButtonClicked));
		addButton(sizeButton = new GuiButtonClick(1, guiLeft + xSize / 2 - 60, guiTop + ySize / 2 - 40, 120, 20, ClientUtils.localize("gui.securitycraft:blockPocketManager.size", size, size, size), this::sizeButtonClicked));
	...
	public void toggleButtonClicked(GuiButtonClick button)
	{
		if(te.enabled)
	...
	public void sizeButtonClicked(GuiButtonClick button)
	{
		size += 4;
