...
public class ClientUtils {
	...
	public static void renderModuleInfo(PoseStack pose, ModuleType module, Component moduleTooltip, boolean isModuleInstalled, int moduleLeft, int moduleTop, int mouseX, int mouseY) {
