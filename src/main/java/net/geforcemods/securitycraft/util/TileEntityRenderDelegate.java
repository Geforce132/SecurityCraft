...
public class TileEntityRenderDelegate {
	public static final TileEntityRenderDelegate DISGUISED_BLOCK = new TileEntityRenderDelegate();
	public static final TileEntityRenderDelegate PROJECTOR = new TileEntityRenderDelegate();
