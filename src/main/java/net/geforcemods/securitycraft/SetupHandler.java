...
public class SetupHandler {
	...
	public static void setupMines() {
		...
		SCContent.dirtMine = new BlockFullMineBase(Material.GROUND, Blocks.DIRT).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 0.5F).setResistance(6000000.0F).setRegistryName("dirt_mine").setTranslationKey("securitycraft:dirtMine");
		SCContent.stoneMine = new BlockFullMineBase(Material.ROCK, Blocks.STONE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 1.5F).setResistance(6000000.0F).setRegistryName("stone_mine").setTranslationKey("securitycraft:stoneMine");
		SCContent.cobblestoneMine = new BlockFullMineBase(Material.ROCK, Blocks.COBBLESTONE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 2.0F).setResistance(6000000.0F).setRegistryName("cobblestone_mine").setTranslationKey("securitycraft:cobblestoneMine");
		...
		SCContent.diamondOreMine = new BlockFullMineBase(Material.ROCK, Blocks.DIAMOND_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("diamond_mine").setTranslationKey("securitycraft:diamondMine");
		...
		SCContent.coalOreMine = new BlockFullMineBase(Material.ROCK, Blocks.COAL_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("coal_mine").setTranslationKey("securitycraft:coal_mine");
		SCContent.emeraldOreMine = new BlockFullMineBase(Material.ROCK, Blocks.EMERALD_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("emerald_mine").setTranslationKey("securitycraft:emerald_mine");
		SCContent.goldOreMine = new BlockFullMineBase(Material.ROCK, Blocks.GOLD_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("gold_mine").setTranslationKey("securitycraft:gold_mine");
		SCContent.ironOreMine = new BlockFullMineBase(Material.ROCK, Blocks.IRON_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("iron_mine").setTranslationKey("securitycraft:iron_mine");
		SCContent.lapisOreMine = new BlockFullMineBase(Material.ROCK, Blocks.LAPIS_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("lapis_mine").setTranslationKey("securitycraft:lapis_mine");
		SCContent.quartzOreMine = new BlockFullMineBase(Material.ROCK, Blocks.QUARTZ_ORE).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("quartz_mine").setTranslationKey("securitycraft:quartz_mine");
