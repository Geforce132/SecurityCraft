...
public class SetupHandler {
	public static void setupBlocks() {
		...
		SCContent.reinforcedStairsOak = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 0, Blocks.OAK_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_oak").setTranslationKey("securitycraft:reinforcedStairsOak");
		SCContent.reinforcedStairsSpruce = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 1, Blocks.SPRUCE_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_spruce").setTranslationKey("securitycraft:reinforcedStairsSpruce");
		SCContent.reinforcedStairsBirch = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 2, Blocks.BIRCH_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_birch").setTranslationKey("securitycraft:reinforcedStairsBirch");
		SCContent.reinforcedStairsJungle = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 3, Blocks.JUNGLE_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_jungle").setTranslationKey("securitycraft:reinforcedStairsJungle");
		SCContent.reinforcedStairsAcacia = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 4, Blocks.ACACIA_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_acacia").setTranslationKey("securitycraft:reinforcedStairsAcacia");
		SCContent.reinforcedStairsDarkoak = new BlockReinforcedStairs(SCContent.reinforcedWoodPlanks, 5, Blocks.DARK_OAK_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_darkoak").setTranslationKey("securitycraft:reinforcedStairsDarkoak");
		SCContent.reinforcedStairsStone = new BlockOwnableStairs(SCContent.reinforcedStone, 0).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_stone").setTranslationKey("securitycraft:reinforcedStairsStone");
		...
		SCContent.reinforcedDirt = new BlockReinforcedDirt().setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_dirt").setTranslationKey("securitycraft:reinforcedDirt");
		...
		SCContent.reinforcedStairsCobblestone = new BlockReinforcedStairs(SCContent.reinforcedCobblestone, 0, Blocks.STONE_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_cobblestone").setTranslationKey("securitycraft:reinforcedStairsCobblestone");
		...
		SCContent.reinforcedStairsSandstone = new BlockReinforcedStairs(SCContent.reinforcedSandstone, 0, Blocks.SANDSTONE_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_sandstone").setTranslationKey("securitycraft:reinforcedStairsSandstone");
		...
		SCContent.reinforcedStairsBrick = new BlockReinforcedStairs(SCContent.reinforcedBrick, 0, Blocks.BRICK_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_brick").setTranslationKey("securitycraft:reinforcedStairsBrick");
		...
		SCContent.reinforcedStairsNetherBrick = new BlockReinforcedStairs(SCContent.reinforcedNetherBrick, 0, Blocks.NETHER_BRICK_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_nether_brick").setTranslationKey("securitycraft:reinforcedStairsNetherBrick");
		...
		SCContent.reinforcedStairsQuartz = new BlockReinforcedStairs(SCContent.reinforcedQuartz, 0, Blocks.QUARTZ_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_quartz").setTranslationKey("securitycraft:reinforcedStairsQuartz");
		...
		SCContent.reinforcedStairsRedSandstone = new BlockReinforcedStairs(SCContent.reinforcedRedSandstone, 0, Blocks.RED_SANDSTONE_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_red_sandstone").setTranslationKey("securitycraft:reinforcedStairsRedSandstone");
		...
		SCContent.reinforcedStairsPurpur = new BlockReinforcedStairs(SCContent.reinforcedPurpur, 0, Blocks.PURPUR_STAIRS).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_stairs_purpur").setTranslationKey("securitycraft:reinforcedStairsPurpur");
		...
		SCContent.reinforcedNetherrack = new BlockReinforcedNetherrack(Material.ROCK, 1, Blocks.NETHERRACK).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_netherrack").setTranslationKey("securitycraft:reinforcedNetherrack");
		...
		SCContent.reinforcedGrass = new BlockReinforcedGrass().setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_grass").setTranslationKey("securitycraft:reinforced_grass");
		SCContent.reinforcedSnowBlock = new BlockReinforcedBase(Material.CRAFTED_SNOW, 1, SoundType.SNOW, Blocks.SNOW).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_snow_block").setTranslationKey("securitycraft:reinforced_snow_block");
		SCContent.reinforcedIce = new BlockReinforcedIce(Material.ICE, 1, SoundType.GLASS, Blocks.ICE).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_ice").setTranslationKey("securitycraft:reinforced_ice");
		SCContent.reinforcedPackedIce = new BlockReinforcedIceBase(Material.PACKED_ICE, 1, SoundType.GLASS, Blocks.PACKED_ICE).setBlockUnbreakable().setResistance(6000000.0F).setCreativeTab(SecurityCraft.tabSCDecoration).setRegistryName("reinforced_packed_ice").setTranslationKey("securitycraft:reinforced_packed_ice");
	...
	public static void setupMines() {
		...
		SCContent.dirtMine = new BlockFullMineBase(Material.GROUND, Blocks.DIRT, 0).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 0.5F).setResistance(6000000.0F).setRegistryName("dirt_mine").setTranslationKey("securitycraft:dirtMine");
		SCContent.stoneMine = new BlockFullMineBase(Material.ROCK, Blocks.STONE, 0).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 1.5F).setResistance(6000000.0F).setRegistryName("stone_mine").setTranslationKey("securitycraft:stoneMine");
		SCContent.cobblestoneMine = new BlockFullMineBase(Material.ROCK, Blocks.COBBLESTONE, 0).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 2.0F).setResistance(6000000.0F).setRegistryName("cobblestone_mine").setTranslationKey("securitycraft:cobblestoneMine");
		SCContent.sandMine = new BlockFullMineFalling(Material.SAND, Blocks.SAND).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 0.5F).setResistance(6000000.0F).setRegistryName("sand_mine").setTranslationKey("securitycraft:sandMine");
		SCContent.diamondOreMine = new BlockFullMineBase(Material.ROCK, Blocks.DIAMOND_ORE, 2).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("diamond_mine").setTranslationKey("securitycraft:diamondMine");
		SCContent.furnaceMine = new BlockFurnaceMine(Material.ROCK).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.5F).setResistance(6000000.0F).setRegistryName("furnace_mine").setTranslationKey("securitycraft:furnaceMine");
		SCContent.gravelMine = new BlockFullMineFalling(Material.GROUND, Blocks.GRAVEL).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 0.6F).setResistance(6000000.0F).setRegistryName("gravel_mine").setTranslationKey("securitycraft:gravelMine");
		...
		SCContent.coalOreMine = new BlockFullMineBase(Material.ROCK, Blocks.COAL_ORE, 0).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("coal_mine").setTranslationKey("securitycraft:coal_mine");
		SCContent.emeraldOreMine = new BlockFullMineBase(Material.ROCK, Blocks.EMERALD_ORE, 2).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("emerald_mine").setTranslationKey("securitycraft:emerald_mine");
		SCContent.goldOreMine = new BlockFullMineBase(Material.ROCK, Blocks.GOLD_ORE, 2).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("gold_mine").setTranslationKey("securitycraft:gold_mine");
		SCContent.ironOreMine = new BlockFullMineBase(Material.ROCK, Blocks.IRON_ORE, 1).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("iron_mine").setTranslationKey("securitycraft:iron_mine");
		SCContent.lapisOreMine = new BlockFullMineBase(Material.ROCK, Blocks.LAPIS_ORE, 1).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("lapis_mine").setTranslationKey("securitycraft:lapis_mine");
		SCContent.quartzOreMine = new BlockFullMineBase(Material.ROCK, Blocks.QUARTZ_ORE, 0).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("quartz_mine").setTranslationKey("securitycraft:quartz_mine");
		SCContent.redstoneOreMine = new BlockRedstoneOreMine().setCreativeTab(SecurityCraft.tabSCMine).setHardness(!ConfigHandler.ableToBreakMines ? -1F : 3.0F).setResistance(6000000.0F).setRegistryName("redstone_mine").setTranslationKey("securitycraft:redstone_mine");
	}
