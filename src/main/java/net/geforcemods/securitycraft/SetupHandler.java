...
public class SetupHandler
{
	...
	public static void setupMines()
	{
		...
		SCContent.gravelMine = new BlockFullMineFalling(Material.ground, Blocks.gravel).setCreativeTab(SecurityCraft.tabSCMine).setHardness(!SecurityCraft.config.ableToBreakMines ? -1F : 1.25F).setStepSound(Block.soundTypeGravel).setUnlocalizedName("securitycraft:gravelMine");
