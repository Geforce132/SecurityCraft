...
public class ItemBlockCrystalQuartzSlab extends ItemBlock {
	private BlockSlab singleSlab = (BlockSlab) SCContent.crystalQuartzSlab;
	private Block doubleSlab = SCContent.doubleCrystalQuartzSlab;

	public ItemBlockCrystalQuartzSlab(Block block) {
		super(block);
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (stack.getCount() == 0)
			...
			if (state.getBlock() instanceof CrystalQuartzSlabBlock) {
