...
public class ModelManagerMixin {
	...
	private static HashMultimap<ModelResourceLocation, Material> securitycraft$captureAtlasPreparations(Operation<HashMultimap<ModelResourceLocation, Material>> original, ProfilerFiller profiler, Map<ResourceLocation, StitchResult> atlasPreperations, ModelBakery modelBakery, Object2IntMap<BlockState> modelGroups) {
