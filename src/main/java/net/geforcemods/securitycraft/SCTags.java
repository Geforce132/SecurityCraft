...
public class SCTags {
	...
	public static class Blocks {
		...
		public static final IOptionalNamedTag<Block> REINFORCED_COBWEB = tag("reinforced/cobweb"); 
		...
		public static final IOptionalNamedTag<Block> REINFORCED_FENCES = tag("reinforced/fences");
		public static final IOptionalNamedTag<Block> REINFORCED_FENCE_GATES = tag("reinforced/fence_gates");
		public static final IOptionalNamedTag<Block> REINFORCED_GLASS_PANES = tag("reinforced/glass_panes");
		...
		public static final IOptionalNamedTag<Block> REINFORCED_STONE_PRESSURE_PLATES = tag("reinforced/stone_pressure_plates");
		public static final IOptionalNamedTag<Block> REINFORCED_TERRACOTTA = tag("reinforced/terracotta");
		public static final IOptionalNamedTag<Block> REINFORCED_WALLS = tag("reinforced/walls"); 
		public static final IOptionalNamedTag<Block> REINFORCED_WARPED_STEMS = tag("reinforced/warped_stems");
		public static final IOptionalNamedTag<Block> REINFORCED_WOODEN_BUTTONS = tag("reinforced/wooden_buttons");
		public static final IOptionalNamedTag<Block> REINFORCED_WOODEN_FENCES = tag("reinforced/wooden_fences");
		public static final IOptionalNamedTag<Block> REINFORCED_WOODEN_FENCE_GATES = tag("reinforced/wooden_fence_gates");
		public static final IOptionalNamedTag<Block> REINFORCED_WOODEN_PRESSURE_PLATES = tag("reinforced/wooden_pressure_plates");
	...
	public static class Items {
		...
		public static final IOptionalNamedTag<Item> KEYCARDS = tag("keycards");
		public static final IOptionalNamedTag<Item> KEYCARD_HOLDER_CAN_HOLD = tag("keycard_holder_can_hold");
		...
		public static final IOptionalNamedTag<Item> REINFORCED_FENCES = tag("reinforced/fences");
		public static final IOptionalNamedTag<Item> REINFORCED_FENCE_GATES = tag("reinforced/fence_gates");
		public static final IOptionalNamedTag<Item> REINFORCED_GLASS_PANES = tag("reinforced/glass_panes");
		...
		public static final IOptionalNamedTag<Item> REINFORCED_STONE_CRAFTING_MATERIALS = tag("reinforced/stone_crafting_materials");
		public static final IOptionalNamedTag<Item> REINFORCED_STONE_BRICKS = tag("reinforced/stone_bricks");
		public static final IOptionalNamedTag<Item> REINFORCED_STONE_PRESSURE_PLATES = tag("reinforced/stone_pressure_plates");
		...
		public static final IOptionalNamedTag<Item> REINFORCED_WOODEN_BUTTONS = tag("reinforced/wooden_buttons");
		public static final IOptionalNamedTag<Item> REINFORCED_WOODEN_FENCES = tag("reinforced/wooden_fences");
		public static final IOptionalNamedTag<Item> REINFORCED_WOODEN_FENCE_GATES = tag("reinforced/wooden_fence_gates");
		public static final IOptionalNamedTag<Item> REINFORCED_WOODEN_PRESSURE_PLATES = tag("reinforced/wooden_pressure_plates");
