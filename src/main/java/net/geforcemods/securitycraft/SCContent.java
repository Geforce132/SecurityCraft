...
public class SCContent {
	...
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> ALARM = BLOCKS.register("alarm", () -> new AlarmBlock(prop(Material.METAL).randomTicks()));
	...
	public static final RegistryObject<Block> BLOCK_POCKET_WALL = BLOCKS.register("block_pocket_wall", () -> new BlockPocketWallBlock(prop().noCollission()));
	@HasManualPage
	...
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> CAGE_TRAP = BLOCKS.register("cage_trap", () -> new CageTrapBlock(propNotSolid(Material.METAL).sound(SoundType.METAL).noCollission()));
	@RegisterItemBlock(SCItemGroup.DECORATION)
	public static final RegistryObject<Block> CHISELED_CRYSTAL_QUARTZ = BLOCKS.register("chiseled_crystal_quartz", () -> new Block(Block.Properties.of(Material.STONE).strength(0.8F)));
	@HasManualPage
	@RegisterItemBlock(SCItemGroup.DECORATION)
	public static final RegistryObject<Block> CRYSTAL_QUARTZ = BLOCKS.register("crystal_quartz", () -> new Block(Block.Properties.of(Material.STONE).strength(0.8F)));
	@RegisterItemBlock(SCItemGroup.DECORATION)
	public static final RegistryObject<Block> CRYSTAL_QUARTZ_PILLAR = BLOCKS.register("crystal_quartz_pillar", () -> new RotatedPillarBlock(Block.Properties.of(Material.STONE).strength(0.8F)));
	@RegisterItemBlock(SCItemGroup.DECORATION)
	public static final RegistryObject<Block> CRYSTAL_QUARTZ_SLAB = BLOCKS.register("crystal_quartz_slab", () -> new SlabBlock(Block.Properties.of(Material.STONE).strength(2.0F, 6.0F)));
	@HasManualPage
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	...
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> INVENTORY_SCANNER = BLOCKS.register("inventory_scanner", () -> new InventoryScannerBlock(propNotSolid()));
	...
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> KEYCARD_READER = BLOCKS.register("keycard_reader", () -> new KeycardReaderBlock(propNotSolid(Material.METAL).sound(SoundType.METAL)));
	@HasManualPage(hasRecipeDescription = true)
	@RegisterItemBlock
	public static final RegistryObject<Block> KEYPAD = BLOCKS.register("keypad", () -> new KeypadBlock(propNotSolid(Material.METAL)));
	@HasManualPage(hasRecipeDescription = true)
	...
	@HasManualPage(hasRecipeDescription = true)
	@RegisterItemBlock
	public static final RegistryObject<AbstractKeypadFurnaceBlock> KEYPAD_FURNACE = BLOCKS.register("keypad_furnace", () -> new KeypadFurnaceBlock(prop(Material.METAL).sound(SoundType.METAL)));
	@HasManualPage(hasRecipeDescription = true)
	@RegisterItemBlock
	public static final RegistryObject<AbstractKeypadFurnaceBlock> KEYPAD_SMOKER = BLOCKS.register("keypad_smoker", () -> new KeypadSmokerBlock(prop(Material.METAL).sound(SoundType.METAL)));
	@HasManualPage(hasRecipeDescription = true)
	@RegisterItemBlock
	public static final RegistryObject<AbstractKeypadFurnaceBlock> KEYPAD_BLAST_FURNACE = BLOCKS.register("keypad_blast_furnace", () -> new KeypadBlastFurnaceBlock(prop(Material.METAL).sound(SoundType.METAL)));
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> LASER_BLOCK = BLOCKS.register("laser_block", () -> new LaserBlock(propNotSolid(Material.METAL).randomTicks().sound(SoundType.METAL)));
	public static final RegistryObject<Block> LASER_FIELD = BLOCKS.register("laser", () -> new LaserFieldBlock(prop()));
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> MOTION_ACTIVATED_LIGHT = BLOCKS.register("motion_activated_light", () -> new MotionActivatedLightBlock(prop(Material.GLASS).sound(SoundType.GLASS)));
	@HasManualPage
	@OwnableTE
	@RegisterItemBlock
	public static final RegistryObject<Block> PANIC_BUTTON = BLOCKS.register("panic_button", () -> new PanicButtonBlock(false, prop()));
	@HasManualPage
	@RegisterItemBlock
	...
	@OwnableTE
	@RegisterItemBlock
	public static final RegistryObject<Block> PROJECTOR = BLOCKS.register("projector", () -> new ProjectorBlock(propNotSolid(Material.METAL).randomTicks().sound(SoundType.METAL)));
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> PROTECTO = BLOCKS.register("protecto", () -> new ProtectoBlock(propNotSolid(Material.METAL).sound(SoundType.METAL)));
	@OwnableTE
	...
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> RETINAL_SCANNER = BLOCKS.register("retinal_scanner", () -> new RetinalScannerBlock(propNotSolid(Material.METAL).sound(SoundType.METAL)));
	...
	@HasManualPage
	public static final RegistryObject<Block> SONIC_SECURITY_SYSTEM = BLOCKS.register("sonic_security_system", () -> new SonicSecuritySystemBlock(prop(Material.METAL).sound(SoundType.METAL).noCollission()));
	@RegisterItemBlock(SCItemGroup.DECORATION)
	...
	public static final RegistryObject<Block> TROPHY_SYSTEM = BLOCKS.register("trophy_system", () -> new TrophySystemBlock(propNotSolid(Material.METAL).sound(SoundType.METAL)));
	@HasManualPage
	@RegisterItemBlock
	public static final RegistryObject<Block> USERNAME_LOGGER = BLOCKS.register("username_logger", () -> new LoggerBlock(propNotSolid()));
	@HasManualPage
	@OwnableTE
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	...
	@HasManualPage(PageGroup.BLOCK_MINES)
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	public static final RegistryObject<Block> GOLD_ORE_MINE = BLOCKS.register("gold_mine", () -> new BaseFullMineBlock(prop(Material.STONE, 3.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE), Blocks.GOLD_ORE));
	@HasManualPage(PageGroup.BLOCK_MINES)
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	public static final RegistryObject<Block> IRON_ORE_MINE = BLOCKS.register("iron_mine", () -> new BaseFullMineBlock(prop(Material.STONE, 3.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE), Blocks.IRON_ORE));
	@HasManualPage(PageGroup.BLOCK_MINES)
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	...
	@HasManualPage(PageGroup.BLOCK_MINES)
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	public static final RegistryObject<Block> LAPIS_ORE_MINE = BLOCKS.register("lapis_mine", () -> new BaseFullMineBlock(prop(Material.STONE, 3.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE), Blocks.LAPIS_ORE));
	@HasManualPage(PageGroup.BLOCK_MINES)
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES)
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHER_BRICK_SLAB = BLOCKS.register("reinforced_nether_brick_slab", () -> new ReinforcedSlabBlock(prop(), Blocks.NETHER_BRICK_SLAB));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_ICE = BLOCKS.register("reinforced_ice", () -> new ReinforcedIceBlock(prop(Material.ICE).friction(0.98F).sound(SoundType.GLASS), Blocks.ICE));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHERRACK = BLOCKS.register("reinforced_netherrack", () -> new ReinforcedNetherrackBlock(prop(), Blocks.NETHERRACK));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_GLOWSTONE = BLOCKS.register("reinforced_glowstone", () -> new BaseReinforcedBlock(prop(Material.GLASS).sound(SoundType.GLASS).lightLevel(15), Blocks.GLOWSTONE));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHER_BRICKS = BLOCKS.register("reinforced_nether_bricks", () -> new BaseReinforcedBlock(prop(), Blocks.NETHER_BRICKS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHER_BRICK_STAIRS = BLOCKS.register("reinforced_nether_brick_stairs", () -> new ReinforcedStairsBlock(prop(), Blocks.NETHER_BRICK_STAIRS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_WHITE_STAINED_GLASS = BLOCKS.register("reinforced_white_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.WHITE, Blocks.WHITE_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_ORANGE_STAINED_GLASS = BLOCKS.register("reinforced_orange_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.ORANGE, Blocks.ORANGE_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_MAGENTA_STAINED_GLASS = BLOCKS.register("reinforced_magenta_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.MAGENTA, Blocks.MAGENTA_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_LIGHT_BLUE_STAINED_GLASS = BLOCKS.register("reinforced_light_blue_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.LIGHT_BLUE, Blocks.LIGHT_BLUE_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_YELLOW_STAINED_GLASS = BLOCKS.register("reinforced_yellow_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.YELLOW, Blocks.YELLOW_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_LIME_STAINED_GLASS = BLOCKS.register("reinforced_lime_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.LIME, Blocks.LIME_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_PINK_STAINED_GLASS = BLOCKS.register("reinforced_pink_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.PINK, Blocks.PINK_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_GRAY_STAINED_GLASS = BLOCKS.register("reinforced_gray_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.GRAY, Blocks.GRAY_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_LIGHT_GRAY_STAINED_GLASS = BLOCKS.register("reinforced_light_gray_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.LIGHT_GRAY, Blocks.LIGHT_GRAY_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_CYAN_STAINED_GLASS = BLOCKS.register("reinforced_cyan_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.CYAN, Blocks.CYAN_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_PURPLE_STAINED_GLASS = BLOCKS.register("reinforced_purple_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.PURPLE, Blocks.PURPLE_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_BLUE_STAINED_GLASS = BLOCKS.register("reinforced_blue_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.BLUE, Blocks.BLUE_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_BROWN_STAINED_GLASS = BLOCKS.register("reinforced_brown_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.BROWN, Blocks.BROWN_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_GREEN_STAINED_GLASS = BLOCKS.register("reinforced_green_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.GREEN, Blocks.GREEN_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_RED_STAINED_GLASS = BLOCKS.register("reinforced_red_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.RED, Blocks.RED_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	public static final RegistryObject<Block> REINFORCED_BLACK_STAINED_GLASS = BLOCKS.register("reinforced_black_stained_glass", () -> new ReinforcedStainedGlassBlock(propNotSolid(Material.GLASS).sound(SoundType.GLASS), DyeColor.BLACK, Blocks.BLACK_STAINED_GLASS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_SEA_LANTERN = BLOCKS.register("reinforced_sea_lantern", () -> new BaseReinforcedBlock(prop(Material.GLASS).sound(SoundType.GLASS).lightLevel(15), Blocks.SEA_LANTERN));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHER_WART_BLOCK = BLOCKS.register("reinforced_nether_wart_block", () -> new BaseReinforcedBlock(prop(Material.GRASS).sound(SoundType.WOOD), Blocks.NETHER_WART_BLOCK));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICKS = BLOCKS.register("reinforced_red_nether_bricks", () -> new BaseReinforcedBlock(prop(), Blocks.RED_NETHER_BRICKS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_BONE_BLOCK = BLOCKS.register("reinforced_bone_block", () -> new ReinforcedRotatedPillarBlock(prop(), Blocks.BONE_BLOCK));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICK_STAIRS = BLOCKS.register("reinforced_red_nether_brick_stairs", () -> new ReinforcedStairsBlock(prop(), Blocks.RED_NETHER_BRICK_STAIRS));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICK_SLAB = BLOCKS.register("reinforced_red_nether_brick_slab", () -> new ReinforcedSlabBlock(prop(), Blocks.RED_NETHER_BRICK_SLAB));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_COBWEB = BLOCKS.register("reinforced_cobweb", () -> new ReinforcedCobwebBlock(prop(Material.WEB).noCollission(), Blocks.COBWEB));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced(hasReinforcedTint = false)
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_NETHER_BRICK_WALL = BLOCKS.register("reinforced_nether_brick_wall", () -> new ReinforcedWallBlock(prop(), Blocks.NETHER_BRICK_WALL));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICK_WALL = BLOCKS.register("reinforced_red_nether_brick_wall", () -> new ReinforcedWallBlock(prop(), Blocks.RED_NETHER_BRICK_WALL));
	@HasManualPage(PageGroup.REINFORCED)
	@OwnableTE
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_LANTERN = BLOCKS.register("reinforced_lantern", () -> new ReinforcedLanternBlock(prop(Material.METAL).sound(SoundType.LANTERN).lightLevel(15), Blocks.LANTERN));

	//ordered by vanilla redstone tab order
	@HasManualPage(PageGroup.REINFORCED)
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_STICKY_PISTON = BLOCKS.register("reinforced_sticky_piston", () -> new ReinforcedPistonBlock(true, prop(Material.PISTON)));
	@HasManualPage(PageGroup.REINFORCED)
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_PISTON = BLOCKS.register("reinforced_piston", () -> new ReinforcedPistonBlock(false, prop(Material.PISTON)));
	@HasManualPage
	@Reinforced
	...
	@OwnableTE
	@Reinforced
	public static final RegistryObject<Block> REINFORCED_REDSTONE_LAMP = BLOCKS.register("reinforced_redstone_lamp", () -> new ReinforcedRedstoneLampBlock(prop(Material.BUILDABLE_GLASS).sound(SoundType.GLASS), Blocks.REDSTONE_LAMP));
	@HasManualPage(PageGroup.BUTTONS)
	@Reinforced
	...
	public static final RegistryObject<Block> REINFORCED_MOVING_PISTON = BLOCKS.register("reinforced_moving_piston", () -> new ReinforcedMovingPistonBlock(prop(Material.PISTON).dynamicShape().noDrops().noOcclusion()));
	...
	public static TileEntityType<LaserBlockBlockEntity> beTypeLaserBlock;
	@ObjectHolder(SecurityCraft.MODID + ":cage_trap")
	public static TileEntityType<CageTrapBlockEntity> beTypeCageTrap;
	@ObjectHolder(SecurityCraft.MODID + ":keycard_reader")
	public static TileEntityType<KeycardReaderBlockEntity> beTypeKeycardReader;
	@ObjectHolder(SecurityCraft.MODID + ":inventory_scanner")
	public static TileEntityType<InventoryScannerBlockEntity> beTypeInventoryScanner;
	@ObjectHolder(SecurityCraft.MODID + ":portable_radar")
	public static TileEntityType<PortableRadarBlockEntity> beTypePortableRadar;
	@ObjectHolder(SecurityCraft.MODID + ":security_camera")
	public static TileEntityType<SecurityCameraBlockEntity> beTypeSecurityCamera;
	@ObjectHolder(SecurityCraft.MODID + ":username_logger")
	public static TileEntityType<UsernameLoggerBlockEntity> beTypeUsernameLogger;
	@ObjectHolder(SecurityCraft.MODID + ":retinal_scanner")
	public static TileEntityType<RetinalScannerBlockEntity> beTypeRetinalScanner;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_chest")
	public static TileEntityType<KeypadChestBlockEntity> beTypeKeypadChest;
	@ObjectHolder(SecurityCraft.MODID + ":alarm")
	public static TileEntityType<AlarmBlockEntity> beTypeAlarm;
	@ObjectHolder(SecurityCraft.MODID + ":claymore")
	public static TileEntityType<ClaymoreBlockEntity> beTypeClaymore;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_furnace")
	public static TileEntityType<AbstractKeypadFurnaceBlockEntity> beTypeKeypadFurnace;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_smoker")
	public static TileEntityType<KeypadSmokerBlockEntity> beTypeKeypadSmoker;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_blast_furnace")
	public static TileEntityType<KeypadBlastFurnaceBlockEntity> beTypeKeypadBlastFurnace;
	@ObjectHolder(SecurityCraft.MODID + ":ims")
	public static TileEntityType<IMSBlockEntity> beTypeIms;
	@ObjectHolder(SecurityCraft.MODID + ":protecto")
	public static TileEntityType<ProtectoBlockEntity> beTypeProtecto;
	@ObjectHolder(SecurityCraft.MODID + ":scanner_door")
	public static TileEntityType<ScannerDoorBlockEntity> beTypeScannerDoor;
	@ObjectHolder(SecurityCraft.MODID + ":secret_sign")
	public static TileEntityType<SecretSignBlockEntity> beTypeSecretSign;
	@ObjectHolder(SecurityCraft.MODID + ":motion_light")
	public static TileEntityType<MotionActivatedLightBlockEntity> beTypeMotionLight;
	@ObjectHolder(SecurityCraft.MODID + ":track_mine")
	public static TileEntityType<TrackMineBlockEntity> beTypeTrackMine;
	@ObjectHolder(SecurityCraft.MODID + ":trophy_system")
	public static TileEntityType<TrophySystemBlockEntity> beTypeTrophySystem;
	@ObjectHolder(SecurityCraft.MODID + ":block_pocket_manager")
	public static TileEntityType<BlockPocketManagerBlockEntity> beTypeBlockPocketManager;
	@ObjectHolder(SecurityCraft.MODID + ":block_pocket")
	public static TileEntityType<BlockPocketBlockEntity> beTypeBlockPocket;
	@ObjectHolder(SecurityCraft.MODID + ":reinforced_pressure_plate")
	public static TileEntityType<AllowlistOnlyBlockEntity> beTypeAllowlistOnly;
	@ObjectHolder(SecurityCraft.MODID + ":reinforced_hopper")
	public static TileEntityType<ReinforcedHopperBlockEntity> beTypeReinforcedHopper;
	@ObjectHolder(SecurityCraft.MODID + ":projector")
	public static TileEntityType<ProjectorBlockEntity> beTypeProjector;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_door")
	public static TileEntityType<KeypadDoorBlockEntity> beTypeKeypadDoor;
	@ObjectHolder(SecurityCraft.MODID + ":reinforced_iron_bars")
	public static TileEntityType<ReinforcedIronBarsBlockEntity> beTypeReinforcedIronBars;
	@ObjectHolder(SecurityCraft.MODID + ":reinforced_cauldron")
	public static TileEntityType<ReinforcedCauldronBlockEntity> beTypeReinforcedCauldron;
	@ObjectHolder(SecurityCraft.MODID + ":reinforced_piston")
	public static TileEntityType<ReinforcedPistonBlockEntity> beTypeReinforcedPiston;
	@ObjectHolder(SecurityCraft.MODID + ":validation_ownable")
	public static TileEntityType<ValidationOwnableBlockEntity> beTypeValidationOwnable;
	@ObjectHolder(SecurityCraft.MODID + ":key_panel")
	public static TileEntityType<KeyPanelBlockEntity> beTypeKeyPanel;
	@ObjectHolder(SecurityCraft.MODID + ":sonic_security_system")
	public static TileEntityType<SonicSecuritySystemBlockEntity> beTypeSonicSecuritySystem;
	...
	public static ContainerType<BlockReinforcerMenu> mTypeBlockReinforcer;
	@ObjectHolder(SecurityCraft.MODID + ":briefcase")
	public static ContainerType<GenericMenu> mTypeBriefcase;
	@ObjectHolder(SecurityCraft.MODID + ":briefcase_inventory")
	public static ContainerType<BriefcaseMenu> mTypeBriefcaseInventory;
	@ObjectHolder(SecurityCraft.MODID + ":briefcase_setup")
	public static ContainerType<GenericMenu> mTypeBriefcaseSetup;
	@ObjectHolder(SecurityCraft.MODID + ":customize_block")
	public static ContainerType<CustomizeBlockMenu> mTypeCustomizeBlock;
	@ObjectHolder(SecurityCraft.MODID + ":disguise_module")
	public static ContainerType<DisguiseModuleMenu> mTypeDisguiseModule;
	@ObjectHolder(SecurityCraft.MODID + ":inventory_scanner")
	public static ContainerType<InventoryScannerMenu> mTypeInventoryScanner;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_furnace")
	public static ContainerType<KeypadFurnaceMenu> mTypeKeypadFurnace;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_smoker")
	public static ContainerType<KeypadSmokerMenu> mTypeKeypadSmoker;
	@ObjectHolder(SecurityCraft.MODID + ":keypad_blast_furnace")
	public static ContainerType<KeypadBlastFurnaceMenu> mTypeKeypadBlastFurnace;
	@ObjectHolder(SecurityCraft.MODID + ":projector")
	...
	private static final Block.Properties propNotSolid() {
		return propNotSolid(Material.STONE);
	}
