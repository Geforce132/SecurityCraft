...
public class SCContent
{
	...
	@RegisterItemBlock(value=SCItemGroup.DECORATION, ignoreDataGen=true) public static final RegistryObject<Block> CRYSTAL_QUARTZ_SLAB = BLOCKS.register("crystal_quartz_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 6.0F).setRequiresTool()));
	@HasManualPage @RegisterItemBlock(value=SCItemGroup.EXPLOSIVES) public static final RegistryObject<Block> CLAYMORE = BLOCKS.register("claymore", () -> new ClaymoreBlock(prop(Material.MISCELLANEOUS)));
	...
	@HasManualPage @RegisterItemBlock(value=SCItemGroup.EXPLOSIVES, ignoreDataGen=true) public static final RegistryObject<Block> IMS = BLOCKS.register("ims", () -> new IMSBlock(prop(Material.IRON, 0.7F).sound(SoundType.METAL)));
