...
public class SCContent
{
	...
	@HasManualPage @RegisterItemBlock(SCItemGroup.DECORATION) public static final RegistryObject<Block> BLOCK_POCKET_WALL = BLOCKS.register("block_pocket_wall", () -> new BlockPocketWallBlock(prop().doesNotBlockMovement().setOpaque(BlockPocketWallBlock::isNormalCube).setSuffocates(BlockPocketWallBlock::causesSuffocation)));
	...
	@HasManualPage @OwnableTE @RegisterItemBlock public static final RegistryObject<Block> PROJECTOR = BLOCKS.register("projector", () -> new ProjectorBlock(prop(Material.IRON).sound(SoundType.METAL).tickRandomly()));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRYING_OBSIDIAN = BLOCKS.register("reinforced_crying_obsidian", () -> new BaseReinforcedBlock(prop().setLightLevel(state -> 10), Blocks.CRYING_OBSIDIAN));
