...
public class SCContent
{
	...
	public static final RegistryObject<Block> SECRET_CRIMSON_SIGN = BLOCKS.register("secret_crimson_sign_standing", () -> new SecretStandingSignBlock(WoodType.CRIMSON));
	public static final RegistryObject<Block> SECRET_CRIMSON_WALL_SIGN = BLOCKS.register("secret_crimson_sign_wall", () -> new SecretWallSignBlock(WoodType.CRIMSON));
	public static final RegistryObject<Block> SECRET_WARPED_SIGN = BLOCKS.register("secret_warped_sign_standing", () -> new SecretStandingSignBlock(WoodType.WARPED));
	public static final RegistryObject<Block> SECRET_WARPED_WALL_SIGN = BLOCKS.register("secret_warped_sign_wall", () -> new SecretWallSignBlock(WoodType.WARPED));
	...
	@RegisterItemBlock(SCItemGroup.EXPLOSIVES) public static final RegistryObject<Block> ANCIENT_DEBRIS_MINE = BLOCKS.register("ancient_debris_mine", () -> new BaseFullMineBlock(Material.IRON, SoundType.ANCIENT_DEBRIS, Blocks.ANCIENT_DEBRIS, 30.0F));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_NYLIUM = BLOCKS.register("reinforced_crimson_nylium", () -> new ReinforcedNyliumBlock(Blocks.CRIMSON_NYLIUM));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_NYLIUM = BLOCKS.register("reinforced_warped_nylium", () -> new ReinforcedNyliumBlock(Blocks.WARPED_NYLIUM));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_PLANKS = BLOCKS.register("reinforced_crimson_planks", () -> new BaseReinforcedBlock(SoundType.WOOD, Material.WOOD, Blocks.CRIMSON_PLANKS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_PLANKS = BLOCKS.register("reinforced_warped_planks", () -> new BaseReinforcedBlock(SoundType.WOOD, Material.WOOD, Blocks.WARPED_PLANKS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_STEM = BLOCKS.register("reinforced_crimson_stem", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.CRIMSON_STEM));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_STEM = BLOCKS.register("reinforced_warped_stem", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.WARPED_STEM));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_STRIPPED_CRIMSON_STEM = BLOCKS.register("reinforced_stripped_crimson_stem", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.STRIPPED_CRIMSON_STEM));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_STRIPPED_WARPED_STEM = BLOCKS.register("reinforced_stripped_warped_stem", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.STRIPPED_WARPED_STEM));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_STRIPPED_CRIMSON_HYPHAE = BLOCKS.register("reinforced_stripped_crimson_hyphae", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.STRIPPED_CRIMSON_HYPHAE));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_STRIPPED_WARPED_HYPHAE = BLOCKS.register("reinforced_stripped_warped_hyphae", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.STRIPPED_WARPED_HYPHAE));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_HYPHAE = BLOCKS.register("reinforced_crimson_hyphae", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.CRIMSON_HYPHAE));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_HYPHAE = BLOCKS.register("reinforced_warped_hyphae", () -> new ReinforcedRotatedPillarBlock(SoundType.HYPHAE, Material.NETHER_WOOD, Blocks.WARPED_HYPHAE));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_SLAB = BLOCKS.register("reinforced_crimson_slab", () -> new ReinforcedSlabBlock(SoundType.WOOD, Material.WOOD, Blocks.CRIMSON_SLAB));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_SLAB = BLOCKS.register("reinforced_warped_slab", () -> new ReinforcedSlabBlock(SoundType.WOOD, Material.WOOD, Blocks.WARPED_SLAB));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_NETHER_BRICK_SLAB = BLOCKS.register("reinforced_nether_brick_slab", () -> new ReinforcedSlabBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.NETHER_BRICK_SLAB));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_NETHERRACK = BLOCKS.register("reinforced_netherrack", () -> new BaseReinforcedBlock(SoundType.NETHERRACK, Material.ROCK, Blocks.NETHERRACK));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_SOUL_SOIL = BLOCKS.register("reinforced_soul_soil", () -> new BaseReinforcedBlock(SoundType.SOUL_SOIL, Material.EARTH, Blocks.SOUL_SOIL));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_BASALT = BLOCKS.register("reinforced_basalt", () -> new ReinforcedRotatedPillarBlock(SoundType.BASALT, Material.ROCK, Blocks.BASALT));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BASALT = BLOCKS.register("reinforced_polished_basalt", () -> new ReinforcedRotatedPillarBlock(SoundType.BASALT, Material.ROCK, Blocks.POLISHED_BASALT));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_GLOWSTONE = BLOCKS.register("reinforced_glowstone", () -> new BaseReinforcedBlock(SoundType.GLASS, Material.GLASS, Blocks.GLOWSTONE, state -> 15));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_NETHER_BRICKS = BLOCKS.register("reinforced_nether_bricks", () -> new BaseReinforcedBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.NETHER_BRICKS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRACKED_NETHER_BRICKS = BLOCKS.register("reinforced_cracked_nether_bricks", () -> new BaseReinforcedBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.CRACKED_NETHER_BRICKS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CHISELED_NETHER_BRICKS = BLOCKS.register("reinforced_chiseled_nether_bricks", () -> new BaseReinforcedBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.CHISELED_NETHER_BRICKS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_STAIRS = BLOCKS.register("reinforced_crimson_stairs", () -> new ReinforcedStairsBlock(SoundType.WOOD, Material.WOOD, Blocks.CRIMSON_STAIRS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_STAIRS = BLOCKS.register("reinforced_warped_stairs", () -> new ReinforcedStairsBlock(SoundType.WOOD, Material.WOOD, Blocks.WARPED_STAIRS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_QUARTZ_BRICKS = BLOCKS.register("reinforced_quartz_bricks", () -> new BaseReinforcedBlock(Material.ROCK, Blocks.QUARTZ_BRICKS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_SEA_LANTERN = BLOCKS.register("reinforced_sea_lantern", () -> new BaseReinforcedBlock(SoundType.GLASS, Material.GLASS, Blocks.SEA_LANTERN, state -> 15));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_NETHER_WART_BLOCK = BLOCKS.register("reinforced_nether_wart_block", () -> new BaseReinforcedBlock(SoundType.WART, Material.ORGANIC, Blocks.NETHER_WART_BLOCK));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_WART_BLOCK = BLOCKS.register("reinforced_warped_wart_block", () -> new BaseReinforcedBlock(SoundType.WART, Material.ORGANIC, Blocks.WARPED_WART_BLOCK));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICKS = BLOCKS.register("reinforced_red_nether_bricks", () -> new BaseReinforcedBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.RED_NETHER_BRICKS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_BONE_BLOCK = BLOCKS.register("reinforced_bone_block", () -> new ReinforcedRotatedPillarBlock(SoundType.BONE, Material.ROCK, Blocks.BONE_BLOCK));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICK_STAIRS = BLOCKS.register("reinforced_red_nether_brick_stairs", () -> new ReinforcedStairsBlock(SoundType.NETHER_BRICK, Material.ROCK, Blocks.RED_NETHER_BRICK_STAIRS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_BLACKSTONE_STAIRS = BLOCKS.register("reinforced_blackstone_stairs", () -> new ReinforcedStairsBlock(SoundType.STONE, Material.ROCK, Blocks.BLACKSTONE_STAIRS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE = BLOCKS.register("reinforced_polished_blackstone", () -> new BaseReinforcedBlock(Material.ROCK, Blocks.POLISHED_BLACKSTONE));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_SLAB = BLOCKS.register("reinforced_polished_blackstone_slab", () -> new ReinforcedSlabBlock(SoundType.STONE, Material.ROCK, Blocks.POLISHED_BLACKSTONE_SLAB));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_STAIRS = BLOCKS.register("reinforced_polished_blackstone_stairs", () -> new ReinforcedStairsBlock(SoundType.STONE, Material.ROCK, Blocks.POLISHED_BLACKSTONE_STAIRS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CHISELED_POLISHED_BLACKSTONE = BLOCKS.register("reinforced_chiseled_polished_blackstone", () -> new BaseReinforcedBlock(Material.ROCK, Blocks.CHISELED_POLISHED_BLACKSTONE));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_BRICKS = BLOCKS.register("reinforced_polished_blackstone_bricks", () -> new BaseReinforcedBlock(Material.ROCK, Blocks.POLISHED_BLACKSTONE_BRICKS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_BRICK_SLAB = BLOCKS.register("reinforced_polished_blackstone_brick_slab", () -> new ReinforcedSlabBlock(SoundType.STONE, Material.ROCK, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_BRICK_STAIRS = BLOCKS.register("reinforced_polished_blackstone_brick_stairs", () -> new ReinforcedStairsBlock(SoundType.STONE, Material.ROCK, Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CRACKED_POLISHED_BLACKSTONE_BRICKS = BLOCKS.register("reinforced_cracked_polished_blackstone_bricks", () -> new BaseReinforcedBlock(Material.ROCK, Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_CHAIN = BLOCKS.register("reinforced_chain", () -> new ReinforcedChainBlock());
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_NETHER_BRICK_WALL = BLOCKS.register("reinforced_nether_brick_wall", () -> new ReinforcedWallBlock(Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(-1.0F, 6000000.0F), Blocks.NETHER_BRICK_WALL));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_RED_NETHER_BRICK_WALL = BLOCKS.register("reinforced_red_nether_brick_wall", () -> new ReinforcedWallBlock(Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(-1.0F, 6000000.0F), Blocks.RED_NETHER_BRICK_WALL));
	...
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_BLACKSTONE_WALL = BLOCKS.register("reinforced_blackstone_wall", () -> new ReinforcedWallBlock(Blocks.BLACKSTONE_WALL));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_WALL = BLOCKS.register("reinforced_polished_blackstone_wall", () -> new ReinforcedWallBlock(Blocks.POLISHED_BLACKSTONE_WALL));
	@OwnableTE @Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_BRICK_WALL = BLOCKS.register("reinforced_polished_blackstone_brick_wall", () -> new ReinforcedWallBlock(Blocks.POLISHED_BLACKSTONE_BRICK_WALL));
	...
	@Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_PRESSURE_PLATE = BLOCKS.register("reinforced_crimson_pressure_plate", () -> new ReinforcedPressurePlateBlock(Sensitivity.EVERYTHING, ReinforcedPressurePlateBlock.WOOD_PROPERTIES, Blocks.CRIMSON_PRESSURE_PLATE));
	@Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_PRESSURE_PLATE = BLOCKS.register("reinforced_warped_pressure_plate", () -> new ReinforcedPressurePlateBlock(Sensitivity.EVERYTHING, ReinforcedPressurePlateBlock.WOOD_PROPERTIES, Blocks.WARPED_PRESSURE_PLATE));
	@Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_PRESSURE_PLATE = BLOCKS.register("reinforced_polished_blackstone_pressure_plate", () -> new ReinforcedPressurePlateBlock(Sensitivity.MOBS, ReinforcedPressurePlateBlock.STONE_PROPERTIES, Blocks.POLISHED_BLACKSTONE_PRESSURE_PLATE));
	...
	@Reinforced public static final RegistryObject<Block> REINFORCED_CRIMSON_BUTTON = BLOCKS.register("reinforced_crimson_button", () -> new ReinforcedButtonBlock(true, ReinforcedButtonBlock.WOOD_PROPERTIES, Blocks.CRIMSON_BUTTON));
	@Reinforced public static final RegistryObject<Block> REINFORCED_WARPED_BUTTON = BLOCKS.register("reinforced_warped_button", () -> new ReinforcedButtonBlock(true, ReinforcedButtonBlock.WOOD_PROPERTIES, Blocks.WARPED_BUTTON));
	@Reinforced public static final RegistryObject<Block> REINFORCED_POLISHED_BLACKSTONE_BUTTON = BLOCKS.register("reinforced_polished_blackstone_button", () -> new ReinforcedButtonBlock(false, ReinforcedButtonBlock.STONE_PROPERTIES, Blocks.POLISHED_BLACKSTONE_BUTTON));
	...
	public static final RegistryObject<Item> SECRET_CRIMSON_SIGN_ITEM = ITEMS.register("secret_crimson_sign_item", () -> new SecretSignItem(SCContent.SECRET_CRIMSON_SIGN.get(), SCContent.SECRET_CRIMSON_WALL_SIGN.get(), "item.securitycraft.secret_crimson_sign_item"));
	public static final RegistryObject<Item> SECRET_WARPED_SIGN_ITEM = ITEMS.register("secret_warped_sign_item", () -> new SecretSignItem(SCContent.SECRET_WARPED_SIGN.get(), SCContent.SECRET_WARPED_WALL_SIGN.get(), "item.securitycraft.secret_warped_sign_item"));
