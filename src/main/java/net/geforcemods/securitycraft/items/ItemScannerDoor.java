...
public class ItemScannerDoor extends Item
{
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		else
		{
			...
			if (player.canPlayerEdit(pos, facing, stack) && SCContent.scannerDoor.canPlaceBlockAt(world, pos))
			{
				...
				boolean isRightHinge = offsetX < 0 && hitZ < 0.5F || offsetX > 0 && hitZ > 0.5F || offsetY < 0 && hitX > 0.5F || offsetY > 0 && hitX < 0.5F;
				placeDoor(world, pos, angleFacing, SCContent.scannerDoor, isRightHinge);
