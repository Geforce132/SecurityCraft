...
public class TileEntityBlockPocketManager extends CustomizableSCTE implements INamedContainerProvider
{
	...
	public TranslationTextComponent enableMultiblock()
	{
		if(!enabled) //multiblock detection
		{
			...
			final Direction managerFacing = world.getBlockState(pos).get(BlockBlockPocketManager.FACING);
	...
	{
		return new ContainerTEGeneric(SCContent.cTypeBlockPocketManager, windowId, world, pos);
	}
