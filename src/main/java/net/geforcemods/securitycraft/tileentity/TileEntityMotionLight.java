...
public class TileEntityMotionLight extends CustomizableSCTE {
	...
	public boolean attackEntity(Entity entity) {
		...
		if(entity instanceof LivingEntity && BlockUtils.getBlock(getWorld(), pos) == SCContent.motionActivatedLight && !BlockUtils.getBlockPropertyAsBoolean(getWorld(), getPos(), BlockMotionActivatedLight.LIT))
