...
public class ReinforcedPistonRenderer extends TileEntitySpecialRenderer<ReinforcedPistonBlockEntity> {
	private BlockRendererDispatcher blockRenderer;

	@Override
	public void render(ReinforcedPistonBlockEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
