...
public class SecretSignRenderer extends TileEntitySpecialRenderer<SecretSignBlockEntity> {
	private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation("textures/entity/sign.png");
	private static final ModelSign model = new ModelSign();

	@Override
	public void render(SecretSignBlockEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
