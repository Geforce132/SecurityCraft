...
public class RetinalScannerRenderer extends TileEntitySpecialRenderer<RetinalScannerBlockEntity> {
	private static final float CORRECT_FACTOR = 1 / 550F;

	@Override
	public void render(RetinalScannerBlockEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
