...
public class ReinforcedPistonBlockEntity extends TileEntity implements IOwnable, ITickable { //this class doesn't extend TileEntityPiston because almost all of that class' content is private
	...
	public void clearPistonTileEntity() {
		if (lastProgress < 1.0F && world != null) {
			...
			if (world.getBlockState(pos).getBlock() == SCContent.reinforcedMovingPiston) {
