...
public class ReinforcedDispenserBlockEntity extends TileEntityDispenser implements IOwnable, IModuleInventory, INameSetter {
	private InsertOnlyInvWrapper insertOnlyHandler;
	...
	public ITextComponent getDefaultName() {
		return Utils.localize(SCContent.reinforcedDispenser);
	}
	...
	private InsertOnlyInvWrapper getInsertOnlyHandler() {
