...
public abstract class FakeLavaFluid extends FlowingFluid {
	...
	@Override
	public BlockState createLegacyBlock(IFluidState state) {
	...
	@Override
	public boolean canBeReplacedWith(IFluidState fluidState, IBlockReader world, BlockPos pos, Fluid fluid, Direction dir) {
		return fluidState.getHeight(world, pos) >= 0.44444445F && fluid.is(FluidTags.WATER);
	}

	@Override
	public int getTickDelay(IWorldReader world) {
		return world.getDimension().isHasCeiling() ? 10 : 30;
	}

	@Override
	public int getSpreadDelay(World world, BlockPos pos, IFluidState fluidState1, IFluidState fluidState2) {
	...
	@Override
	protected void spreadTo(IWorld world, BlockPos pos, BlockState blockState, Direction direction, IFluidState fluidState) {
	...
	public static class Flowing extends FakeLavaFluid {
		...
		@Override
		public int getAmount(IFluidState state) {
