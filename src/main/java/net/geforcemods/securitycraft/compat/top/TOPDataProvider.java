...
public class TOPDataProvider {// implements Function<ITheOneProbe, Void> {
	// private static final MutableComponent EQUIPPED =
	// Utils.localize("waila.securitycraft:equipped").withStyle(ChatFormatting.GRAY);
	// private static final MutableComponent ALLOWLIST_MODULE = Component.literal("-
	// ").append(Component.translatable(ModuleType.ALLOWLIST.getTranslationKey())).withStyle(ChatFormatting.GRAY);
	// private static final MutableComponent DISGUISE_MODULE = Component.literal("-
	// ").append(Component.translatable(ModuleType.DISGUISE.getTranslationKey())).withStyle(ChatFormatting.GRAY);
	// private static final MutableComponent SPEED_MODULE = Component.literal("-
	// ").append(Component.translatable(ModuleType.SPEED.getTranslationKey())).withStyle(ChatFormatting.GRAY);
	//
	// @Nullable
	// @Override
...
//				//@formatter:on
	...
	//
	// @Override
	// public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, Player player, Level level, BlockState blockState,
	// IProbeHitData data) {
	...
	// probeInfo.vertical().mcText(Utils.localize("waila.securitycraft:owner",
	// PlayerUtils.getOwnerComponent(ownable.getOwner())).withStyle(ChatFormatting.GRAY));
	//
	...
	// probeInfo.mcText(Component.literal("-
	// ").append(Component.translatable(module.getTranslationKey())).withStyle(ChatFormatting.GRAY));
	// }
	// }
	// }
	//
	...
	//
	// probeInfo.mcText(Utils.localize("waila.securitycraft:customName", text == null ? Component.empty() :
	...
	//
	// @Override
	// public void addProbeEntityInfo(ProbeMode probeMode, IProbeInfo probeInfo, Player player, Level level, Entity entity,
	// IProbeHitEntityData data) {
	// if (entity instanceof Sentry sentry) {
	// SentryMode mode = sentry.getMode();
	//
	// probeInfo.mcText(Utils.localize("waila.securitycraft:owner",
	// PlayerUtils.getOwnerComponent(sentry.getOwner())).withStyle(ChatFormatting.GRAY));
	//
