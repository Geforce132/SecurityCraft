...
public class CyclicCompat
{
	...
	{
		if(PlayerUtils.isHoldingItem(event.getPlayer(), ItemRegistry.tile_transporter) || PlayerUtils.isHoldingItem(event.getPlayer(), ItemRegistry.tile_transporterempty))
		{
