 ...
 *
 * <pre>
 * FMLInterModComms.sendFunctionMessage("securitycraft", SecurityCraftAPI.IMC_DOOR_ACTIVATOR_MSG, "your.package.ClassThatImplementsIDoorActivator");
 * </pre>
 *
 * during InterModEnqueueEvent to register this with SecurityCraft.<br> Do note, that you also need to implement
 * Function<Object,IDoorActivator> on the class that you send via IMC. You can just return <code>this</code> in the apply
