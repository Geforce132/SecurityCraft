...
public interface IViewActivated {
	...
	default void checkView(World world, BlockPos pos) {
		...
		for (LivingEntity entity : entities)
		{
			...
			RayTraceResult mop = world.rayTraceBlocks(new RayTraceContext(new Vector3d(entity.getPosX(), entity.getPosY() + entity.getEyeHeight(), entity.getPosZ()), lookVec, BlockMode.COLLIDER, FluidMode.NONE, entity));
