...
public class SecurityCraftAPI {
	...
	public static void onInterModProcess(InterModProcessEvent event) {
		...
		event.getIMCStream(s -> s.equals(IMC_PASSCODE_CONVERTIBLE_MSG)).forEach(msg -> registeredPasscodeConvertibles.add((IPasscodeConvertible) msg.getMessageSupplier().get()));
