...
public class PictureButton extends ClickButton {
	...
	public PictureButton(int id, int xPos, int yPos, int width, int height, RenderItem renderItem, ItemStack itemToRender) {
		this(id, xPos, yPos, width, height, renderItem, itemToRender, null);
	}

	public PictureButton(int id, int xPos, int yPos, int width, int height, ResourceLocation texture, int textureX, int textureY, int drawOffsetX, int drawOffsetY, int drawWidth, int drawHeight, int textureWidth, int textureHeight) {
	...
	public PictureButton(int id, int xPos, int yPos, int width, int height, RenderItem renderItem, ItemStack itemToRender, Consumer<ClickButton> onClick) {
	...
	public PictureButton(int id, int xPos, int yPos, int width, int height, ResourceLocation texture, int textureX, int textureY, int drawOffsetX, int drawOffsetY, int drawWidth, int drawHeight, int textureWidth, int textureHeight, Consumer<ClickButton> onClick) {
		super(id, xPos, yPos, width, height, "", onClick);
