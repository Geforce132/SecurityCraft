...
public class KeycardReaderScreen extends ContainerScreen<KeycardReaderContainer>
{
	...
	public void init()
	{
		...
		minusThree = addButton(new GuiButtonExt(guiLeft + 22, buttonY, 24, buttonHeight, "---", b -> changeSignature(signature - 100)));
		minusTwo = addButton(new GuiButtonExt(guiLeft + 48, buttonY, 18, buttonHeight, "--", b -> changeSignature(signature - 10)));
		minusOne = addButton(new GuiButtonExt(guiLeft + 68, buttonY, 12, buttonHeight, "-", b -> changeSignature(signature - 1)));
		...
		plusOne = addButton(new GuiButtonExt(guiLeft + 96, buttonY, 12, buttonHeight, "+", b -> changeSignature(signature + 1)));
		plusTwo = addButton(new GuiButtonExt(guiLeft + 110, buttonY, 18, buttonHeight, "++", b -> changeSignature(signature + 10)));
		plusThree = addButton(new GuiButtonExt(guiLeft + 130, buttonY, 24, buttonHeight, "+++", b -> changeSignature(signature + 100)));
		//set correct signature
		changeSignature(signature);
		//link button
		linkButton = addButton(new GuiButtonExt(guiLeft + 8, guiTop + 126, 70, 20, linkText, b -> {
		...
		if(!isSmart)
		{
			...
			addButton(new GuiButtonExt(guiLeft + 135, guiTop + 67, 18, 18, isExactLevel ? EQUALS : GREATER_THAN_EQUALS, b -> {
