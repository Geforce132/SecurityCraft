...
public class KeypadSmokerScreen extends AbstractFurnaceScreen<KeypadSmokerMenu> {
	private static final Identifier LIT_PROGRESS_SPRITE = SecurityCraft.mcResLoc("container/smoker/lit_progress");
	private static final Identifier BURN_PROGRESS_SPRITE = SecurityCraft.mcResLoc("container/smoker/burn_progress");
	private static final Identifier TEXTURE = SecurityCraft.mcResLoc("textures/gui/container/smoker.png");
