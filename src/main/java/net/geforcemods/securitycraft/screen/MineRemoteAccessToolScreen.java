...
public class MineRemoteAccessToolScreen extends Screen{
	...
	public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks)
	{
		...
		font.func_243248_b(matrix, mratName, startX + xSize / 2 - font.func_238414_a_(mratName), startY + -25 + 13, 0xFF0000);
		...
		for(int i = 0; i < 6; i++)
		{
			...
			font.func_243248_b(matrix, line, startX + xSize / 2 - font.func_238414_a_(line) + 25, startY + i * 30 + 13, 4210752);
		}
