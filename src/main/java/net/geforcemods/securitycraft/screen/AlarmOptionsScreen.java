...
public class AlarmOptionsScreen extends Screen {
	...
	protected void init() {
		...
		pitchSlider = addRenderableWidget(new CallbackSlider(leftPos + imageWidth / 2 - 50, buttonY + 25, 100, 20, Utils.localize("gui.securitycraft:alarm.pitch", ""), TextComponent.EMPTY, 0.5D, 2.0D, alarmScreen.pitch, 0.05D, 0, true, slider -> alarmScreen.pitch = (float) slider.getValue()));
