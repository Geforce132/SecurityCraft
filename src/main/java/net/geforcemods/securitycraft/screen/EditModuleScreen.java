...
public class EditModuleScreen extends Screen {
	...
	public void init() {
		...
		addButton(addButton = new ExtendedButton(controlsStartX, height / 2 - 55, 76, 20, Utils.localize("gui.securitycraft:editModule.add"), this::addButtonClicked));
		addButton(removeButton = new ExtendedButton(controlsStartX, height / 2 - 30, 76, 20, Utils.localize("gui.securitycraft:editModule.remove"), this::removeButtonClicked));
		addButton(copyButton = new ExtendedButton(controlsStartX, height / 2 - 5, 76, 20, Utils.localize("gui.securitycraft:editModule.copy"), this::copyButtonClicked));
		addButton(pasteButton = new ExtendedButton(controlsStartX, height / 2 + 20, 76, 20, Utils.localize("gui.securitycraft:editModule.paste"), this::pasteButtonClicked));
		addButton(clearButton = new ExtendedButton(controlsStartX, height / 2 + 45, 76, 20, Utils.localize("gui.securitycraft:editModule.clear"), this::clearButtonClicked));
