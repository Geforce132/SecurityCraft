...
public class KeypadFurnaceScreen extends ContainerScreen<KeypadFurnaceContainer>
{
	...
	{
		String s = gurnace ? "Keypad Gurnace" : (tileFurnace.hasCustomName() ? tileFurnace.getCustomName().getFormattedText() : Utils.localize("gui.securitycraft:protectedFurnace.name").getFormattedText());
