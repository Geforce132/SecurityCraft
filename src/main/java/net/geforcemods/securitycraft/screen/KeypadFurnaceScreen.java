...
public class KeypadFurnaceScreen extends AbstractFurnaceScreen<KeypadFurnaceMenu> {
	private static final Identifier LIT_PROGRESS_SPRITE = SecurityCraft.mcResLoc("container/furnace/lit_progress");
	private static final Identifier BURN_PROGRESS_SPRITE = SecurityCraft.mcResLoc("container/furnace/burn_progress");
	private static final Identifier TEXTURE = SecurityCraft.mcResLoc("textures/gui/container/furnace.png");
