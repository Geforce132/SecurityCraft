...
public class CameraMonitorScreen extends Screen {
	...
	public void init() {
		...
		cameraButtons[2] = new CameraButton(3, width / 2 + 22, height / 2 - 60 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[3] = new CameraButton(4, width / 2 - 38, height / 2 - 30 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[4] = new CameraButton(5, width / 2 - 8, height / 2 - 30 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[5] = new CameraButton(6, width / 2 + 22, height / 2 - 30 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[6] = new CameraButton(7, width / 2 - 38, height / 2 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[7] = new CameraButton(8, width / 2 - 8, height / 2 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[8] = new CameraButton(9, width / 2 + 22, height / 2 + 10, 20, 20, "", this::cameraButtonClicked);
		cameraButtons[9] = new CameraButton(10, width / 2 - 38, height / 2 + 40, 80, 20, "", this::cameraButtonClicked);
	...
	private static class CameraButton extends ExtendedButton {
		...
		public CameraButton(int camId, int xPos, int yPos, int width, int height, String displayString, IPressable handler) {
