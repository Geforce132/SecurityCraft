...
public class InventoryScannerScreen extends ContainerScreen<InventoryScannerContainer> {
	...
	public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks){
		...
		font.func_243248_b(matrix, redstoneString, guiLeft + 5, guiTop + 40, 4210752);
		font.func_243248_b(matrix, storageString, guiLeft + 5, guiTop + 50, 4210752);
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrix, int mouseX, int mouseY)
	{
		...
		font.func_243248_b(matrix, new StringTextComponent("Prohibited Items"), 8, 6, 4210752);
		...
		if(hasStorageModule && owns)
			font.func_243248_b(matrix, new StringTextComponent("Storage"), 183, 6, 4210752);
