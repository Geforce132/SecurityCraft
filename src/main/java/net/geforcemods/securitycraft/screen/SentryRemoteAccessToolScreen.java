...
public class SentryRemoteAccessToolScreen extends Screen {
	...
	public void init() {
		...
		guiButtonsGlobal[UNBIND] = new ClickButton(1002, startX + 44 + 260, startY + 188, 20, 20, "X", this::clickGlobalUnbind);
	...
	public void render(int mouseX, int mouseY, float partialTicks)
	{
		...
		font.drawString(ClientUtils.localize(SCContent.REMOTE_ACCESS_SENTRY.get().getTranslationKey()).getFormattedText(), startX + 5, startY - 25 + 13, 0xFF0000);
