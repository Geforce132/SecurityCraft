...
public class BouncingBettyEntity extends Entity {
	...
	{
		world.createExplosion(this, posX, posY, posZ, ConfigHandler.SERVER.smallerMineExplosion.get() ? 3.0F : 6.0F, ConfigHandler.SERVER.shouldSpawnFire.get(), BlockUtils.getExplosionMode());
	}
