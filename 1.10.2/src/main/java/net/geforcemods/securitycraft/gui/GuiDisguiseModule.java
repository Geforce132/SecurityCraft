...
public class GuiDisguiseModule extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(I18n.format("item.disguiseModule.name"), this.xSize / 2 - this.fontRendererObj.getStringWidth(I18n.format("item.disguiseModule.name")) / 2, 6, 4210752);
	}
