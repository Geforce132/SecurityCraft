...
public class GuiDisguiseModule extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		fontRendererObj.drawString(ClientUtils.localize("item.securitycraft:disguiseModule.name"), xSize / 2 - fontRendererObj.getStringWidth(ClientUtils.localize("item.securitycraft:disguiseModule.name")) / 2, 6, 4210752);
	}
