...
public class BlockLogger extends ContainerBlock {
	...
	public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
		if(!world.isRemote && player instanceof ServerPlayerEntity)
			NetworkHooks.openGui((ServerPlayerEntity)player, new BaseInteractionObject(GuiHandler.USERNAME_LOGGER), pos);
	...
	public TileEntity createNewTileEntity(IBlockReader reader) {
		return new TileEntityLogger().attacks(PlayerEntity.class, CommonConfig.CONFIG.usernameLoggerSearchRadius.get(), 80);
	}
}
