...
public class GuiKeypadSetup extends GuiContainer
{
    ...
    protected void actionPerformed(GuiButton guibutton){
		...
		case 0:
			...
			Minecraft.getMinecraft().thePlayer.openGui(mod_SecurityCraft.instance, 0, keypadInventory.getWorld(), keypadInventory.getPos().getX(), keypadInventory.getPos().getY(), keypadInventory.getPos().getZ());	
		}
	}	
