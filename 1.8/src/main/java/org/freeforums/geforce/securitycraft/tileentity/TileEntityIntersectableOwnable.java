...
public class TileEntityIntersectableOwnable extends TileEntityOwnable implements IUpdatePlayerListBox{
	...
	public void run(EntityPlayer player) {
		((IIntersectable) this.worldObj.getBlockState(getPos()).getBlock()).onEntityIntersected(getWorld(), getPos(), player);
	}
