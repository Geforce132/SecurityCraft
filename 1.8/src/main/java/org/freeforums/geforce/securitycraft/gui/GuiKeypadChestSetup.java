...
public class GuiKeypadChestSetup extends GuiContainer
{
	...
	protected void actionPerformed(GuiButton guibutton){
		...
		case 0:
			...
			Minecraft.getMinecraft().thePlayer.openGui(mod_SecurityCraft.instance, 13, Minecraft.getMinecraft().theWorld, keypadInventory.getPos().getX(), keypadInventory.getPos().getY(), keypadInventory.getPos().getZ());
