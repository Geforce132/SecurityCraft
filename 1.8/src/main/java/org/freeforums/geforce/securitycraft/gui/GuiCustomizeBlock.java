...
public class GuiCustomizeBlock extends GuiContainer{
    ...
    public void initGui(){
    	...
    	for(int i = 0; i < tileEntity.getNumberOfCustomizableOptions(); i++){
    		GuiPictureButton button = new GuiPictureButton(i, guiLeft + 130, (guiTop + 10) + (i * 25), 20, 20, "", this.itemRender, new ItemStack(HelpfulMethods.getItemFromModule(tileEntity.getCustomizableOptions()[i])), "");
