...
public class GuiKeypadFurnace extends GuiContainer
{
	...
	public GuiKeypadFurnace(InventoryPlayer par1InventoryPlayer, TileEntityKeypadFurnace par2TileEntityFurnace)
    {
	...
	private void checkCode(String par1String) {
		mod_SecurityCraft.network.sendToServer(new PacketCheckKeypadCode(keypadInventory.getPos().getX(), keypadInventory.getPos().getY(), keypadInventory.getPos().getZ(), par1String));		
	}
