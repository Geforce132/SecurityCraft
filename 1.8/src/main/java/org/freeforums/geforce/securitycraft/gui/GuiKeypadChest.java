...
//TODO
public class GuiKeypadChest extends GuiContainer
{
    ...
    public GuiKeypadChest(InventoryPlayer par1InventoryPlayer, TileEntityKeypadChest par2TileEntityFurnace)
    {
        super(new ContainerKeypadChest(par1InventoryPlayer, par2TileEntityFurnace));
    ...
    public void initGui(){
		...
		this.textboxKeycode = new GuiTextField(11, this.fontRendererObj, this.width / 2 - 37, this.height / 2 - 67, 77, 12);
    ...
    public void drawScreen(int par1, int par2, float par3){
		...
		this.setTextboxCensoredText(this.textboxKeycode, this.textboxKeycode.getText());	
    }
    ...
    {
        this.fontRendererObj.drawString("Password-protected chest", this.xSize / 2 - this.fontRendererObj.getStringWidth("Password-protected chest") / 2, 6, 4210752);
    }
	...
	private void checkCode(String par1String) {
		mod_SecurityCraft.network.sendToServer(new PacketCheckKeypadCode(this.keypadInventory.getPos().getX(), this.keypadInventory.getPos().getY(), this.keypadInventory.getPos().getZ(), par1String));
	}
