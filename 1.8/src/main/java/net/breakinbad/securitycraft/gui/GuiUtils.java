...
public class GuiUtils extends Gui{
	...
	public static void drawCameraOverlay(Minecraft mc, Gui gui, ScaledResolution resolution, EntityPlayer player, World world, BlockPos pos) {
	    ...
	    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(GameSettings.getKeyDisplayString(KeyBindings.cameraEmitLight.getKeyCode()) + " - Activate light", resolution.getScaledWidth() - 108 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(GameSettings.getKeyDisplayString(KeyBindings.cameraEmitLight.getKeyCode()) + " - Activate light") / 2, resolution.getScaledHeight() - 40, 16777215);
	    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(GameSettings.getKeyDisplayString(KeyBindings.cameraEmitRedstone.getKeyCode()) + " - Toggle redstone signal", resolution.getScaledWidth() - 82 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(GameSettings.getKeyDisplayString(KeyBindings.cameraEmitRedstone.getKeyCode()) + " - Toggle redstone signal") / 2, resolution.getScaledHeight() - 30, ((CustomizableSCTE) world.getTileEntity(pos)).hasModule(EnumCustomModules.REDSTONE) ? 16777215 : 16724855);
	    ...
	    if(BlockUtils.getBlock(world, pos) == mod_SecurityCraft.securityCamera){
	    	gui.drawTexturedModalRect(46, 3, 90, 24, 10, 12);
		}else if(BlockUtils.getBlock(world, pos) == mod_SecurityCraft.securityCameraLit){
