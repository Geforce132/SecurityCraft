...
public class EntityAITargetNearestPlayerOrMob extends EntityAINearestAttackableTarget
{
	...
	{
		List<EntityLivingBase> list = taskOwner.worldObj.getEntitiesWithinAABB(targetClass, taskOwner.getEntityBoundingBox().expand(getTargetDistance(), 4.0D, getTargetDistance()), targetEntitySelector);
