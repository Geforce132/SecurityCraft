...
@Mod(modid = SecurityCraft.MODID, name = "SecurityCraft", version = SecurityCraft.VERSION, guiFactory = "net.geforcemods.securitycraft.gui.SecurityCraftGuiFactory", dependencies = SecurityCraft.DEPENDENCIES, /*updateJSON = SecurityCraft.UPDATEJSONURL, wtf why is this not in @Mod*/acceptedMinecraftVersions = "[1.8]")
public class SecurityCraft {
	public static boolean debug;
	public static final String MODID = "securitycraft";
	private static final String MOTU = "Finally! Cameras!";
	//********************************* This is v1.8.12.1 for MC 1.8!
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		proxy.registerResourceLocations();
