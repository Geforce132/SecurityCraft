...
public class BlockKeypadChest extends BlockChest implements IPasswordConvertible {
	...
	{
		Iterator<Entity> iterator = world.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB(pos.getX(), pos.getY() + 1, pos.getZ(), pos.getX() + 1, pos.getY() + 2, pos.getZ() + 1)).iterator();
		EntityOcelot ocelot;
