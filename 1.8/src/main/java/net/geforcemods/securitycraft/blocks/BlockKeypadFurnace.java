...
public class BlockKeypadFurnace extends BlockOwnable implements IPasswordConvertible {
	...
	public int getLightValue(IBlockAccess world, BlockPos pos)
	{
		...
		return (((Boolean)world.getBlockState(pos).getValue(OPEN)).booleanValue() && te != null && te instanceof TileEntityKeypadFurnace && ((TileEntityKeypadFurnace)te).isBurning()) ? 15 : 0;
	}
