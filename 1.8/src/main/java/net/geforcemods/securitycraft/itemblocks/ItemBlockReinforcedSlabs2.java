...
public class ItemBlockReinforcedSlabs2 extends ItemBlockTinted {
	...
	private IBlockState getDoubleSlabBlock(Comparable<?> type) {
		if(type == BlockReinforcedSlabs2.EnumType.RED_SANDSTONE)
			return SCContent.reinforcedDoubleStoneSlabs2.getDefaultState().withProperty(BlockReinforcedSlabs2.VARIANT, type);
		else
			return null;
	}
