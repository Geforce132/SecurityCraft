...
public class GuiMRATActivate extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
        this.fontRenderer.drawString(TextFormatting.UNDERLINE + ClientUtils.localize("gui.mrat.activate"), this.xSize / 2 - this.fontRenderer.getStringWidth(ClientUtils.localize("gui.mrat.detonate")) / 2, 6, 4210752);
    }
