...
public class GuiMRATDeactivate extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
        this.fontRendererObj.drawString(TextFormatting.UNDERLINE + ClientUtils.localize("gui.mrat.deactivate"), this.xSize / 2 - this.fontRendererObj.getStringWidth(ClientUtils.localize("gui.mrat.detonate")) / 2, 6, 4210752);
    }
    ...
    private void updateButton(GuiButton guibutton) {
		...
		guibutton.displayString = guibutton.enabled ? "" : ClientUtils.localize("gui.mrat.deactivated");
	}
