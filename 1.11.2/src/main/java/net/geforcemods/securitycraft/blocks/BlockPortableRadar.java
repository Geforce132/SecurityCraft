...
public class BlockPortableRadar extends BlockContainer {
	...
	public static void searchForPlayers(World par1World, BlockPos pos, IBlockState state){
		if(!par1World.isRemote){
			...
			AxisAlignedBB axisalignedbb = BlockUtils.fromBounds(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1).expand(d0, d0, d0).setMaxY(par1World.getHeight());
