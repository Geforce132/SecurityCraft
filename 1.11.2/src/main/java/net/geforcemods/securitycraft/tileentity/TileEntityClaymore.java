	...
	public void update() {
		if(getWorld().isRemote)
			...
			if(dir == EnumFacing.NORTH)
				axisalignedbb = axisalignedbb.expand(0, 0, -SecurityCraft.config.claymoreRange);
			else if(dir == EnumFacing.SOUTH)
				axisalignedbb = axisalignedbb.expand(0, 0, SecurityCraft.config.claymoreRange);if(dir == EnumFacing.EAST)
					axisalignedbb = axisalignedbb.expand(SecurityCraft.config.claymoreRange, 0, 0);
