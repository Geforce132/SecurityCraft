...
public class TileEntityPortableRadar extends CustomizableSCTE {
	...
	private OptionDouble searchRadiusOption = new OptionDouble("searchRadius", ServerConfig.CONFIG.portableRadarSearchRadius.get(), 5.0D, 50.0D, 5.0D);
	private OptionInt searchDelayOption = new OptionInt("searchDelay", ServerConfig.CONFIG.portableRadarDelay.get(), 4, 10, 1);
