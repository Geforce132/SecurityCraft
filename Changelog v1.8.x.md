...
- New: Config option "enableTeamOwnership". Setting this to true will allow all players in the same team to own each other's blocks, as well as implicitly be added to allowlists/denylists if only one player on the team is added to the list
