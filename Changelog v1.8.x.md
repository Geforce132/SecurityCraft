...
- Fix: Reinforced Iron Bars do not show up in the inventory
...
- Fix: Reinforced Doors cannot be opened
...
--------------------------Changelog for v1.8.2.2-beta2 of SecurityCraft--------------------------

- Fix: Crash when starting a server
