...
- Fix: Crash involving the Motion Activated Light
...
- Fix: I.M.S. doesn't detect targets correctly
...
- Fix: Reinforced Doors can be opened by anybody's Laser Block, if it was placed directly north of the door
...
--------------------------Changelog for v1.8.2.2-beta4 of SecurityCraft--------------------------

- New: Discord tip
- New: Stained Reinforced Glass now colors beacon beams
- Fix: Alarm bounding box is too large for top/bottom alarm
- Fix: Missing world textures of SecurityCamera/I.M.S.
- Fix: Inability to place down liquids
- Fix: Missing Reinforced Fencegate recipe
- Fix: Manual crash
- Fix: Incorrect Manual pages
- Fix: Missing language strings in Manual
- Fix: Pick block does not work on Keypads
- Fix: Inventory Scanner duplication bug
- Fix: Fake Water/Lava recipes don't work
- Fix: WAILA not working
- Fix: Modules not showing up on buttons in the Universal Block Modifier GUI

--------------------------Changelog for v1.8.2.2-beta3 of SecurityCraft--------------------------

- Fix: Keypad crash when placing it next to blocks
- Fix: SecurityCamera can be placed down anywhere
- Fix: SecurityCamera breaks on each block update
- Fix: Reinforced Planks do not show up correctly in WAILA
- Fix: Player gets disconnected when server sends message to them
