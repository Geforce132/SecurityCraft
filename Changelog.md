...
- New: The Allowlist/Denylist Module, Camera Monitor, Mine/Sentry Remote Access Tool, and Sonic Security System can now be copied in the crafting table, by combining two of the same item (one empty, one with data) in a crafting table
