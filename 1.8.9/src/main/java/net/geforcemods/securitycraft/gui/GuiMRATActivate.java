...
public class GuiMRATActivate extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		fontRendererObj.drawString(EnumChatFormatting.UNDERLINE + StatCollector.translateToLocal("gui.mrat.activate"), xSize / 2 - fontRendererObj.getStringWidth(StatCollector.translateToLocal("gui.mrat.detonate")) / 2, 6, 4210752);
	}
